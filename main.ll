...
@.str._func71_str2 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@_func71_str2 = constant i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str._func71_str2, i32 0, i32 0), align 8
@.str._func71_str3 = private unnamed_addr constant [26 x i8] c"\0A%c[0;%dmwarning:%c[0m %s\00", align 1
@_func71_str3 = constant i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str._func71_str3, i32 0, i32 0), align 8
