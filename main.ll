...
%Value = type {%ValueKind, %Type*, %Int64, %Nat32, %Str, %ValueUn, %ValueBin, %ValueIndex, %ValueAccess, %ValueCast, %ValueCall, %Type*, %AssemblyItem*, %VarDef*, %Field*, %Expr*, %TokenInfo*, %TokenInfo*, %TokenInfo*}
...
@.str._func194_str1 = private unnamed_addr constant [14 x i8] c"asmTypedefAdd\00", align 1
@_func194_str1 = constant i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str._func194_str1, i32 0, i32 0), align 8
@.str._func195_str1 = private unnamed_addr constant [13 x i8] c"asmStringAdd\00", align 1
@_func195_str1 = constant i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str._func195_str1, i32 0, i32 0), align 8
@.str._func196_str1 = private unnamed_addr constant [12 x i8] c"asmArrayAdd\00", align 1
@_func196_str1 = constant i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str._func196_str1, i32 0, i32 0), align 8
@.str._func197_str1 = private unnamed_addr constant [11 x i8] c"asmFuncAdd\00", align 1
@_func197_str1 = constant i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str._func197_str1, i32 0, i32 0), align 8
@.str._func198_str1 = private unnamed_addr constant [10 x i8] c"asmVarAdd\00", align 1
@_func198_str1 = constant i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str._func198_str1, i32 0, i32 0), align 8
...
@.str._func298_str1 = private unnamed_addr constant [18 x i8] c"\0A  %%%d = alloca \00", align 1
...
@.str._func325_str4 = private unnamed_addr constant [5 x i8] c"%%%d\00", align 1
...
;stmt0:
  %3 = call %Stmt* (%StmtKind, %TokenInfo*) @stmtNew (%StmtKind 3, %TokenInfo* %1)
...
;stmt9:
  %10 = getelementptr inbounds %Stmt, %Stmt* %0, i32 0, i32 3
  %11 = load %Expr*, %Expr** %10
  call void (%Expr*) @stmtExprCheck (%Expr* %11)
  br label %endif_2
else_2:

;stmt10:
  %12 = icmp eq %StmtKind %7, 4
...
;stmt15:
  %14 = getelementptr inbounds %Stmt, %Stmt* %0, i32 0, i32 2
  %15 = load %Block*, %Block** %14
  call void (%Block*) @stmtBlockCheck (%Block* %15)
  br label %endif_4
else_4:
...
;stmt30:
  %35 = load %Str, %Str* @_func199_str6
  call void (%Str, %TokenInfo*) @error (%Str %35, %TokenInfo* %4)

;stmt31:
  %36 = load %Str, %Str* @_func199_str7
  %37 = call %Token* () @ctok ()
...
;stmt22:
  %56 = load %Str, %Str* @_func230_str3
  call void (%Str, %TokenInfo*) @error (%Str %56, %TokenInfo* %2)

;stmt23:
  %57 = load %Str, %Str* @_func230_str4
...
;stmt25:
  %61 = load %Str, %Str* @_func230_str5
  %62 = call %Int32 (%Str, ...) @printf (%Str %61)

;stmt26:
  %63 = load %Str, %Str* @_func230_str6
...
;stmt11:
  %21 = getelementptr inbounds %Stmt, %Stmt* %0, i32 0, i32 3
  %22 = load %Expr*, %Expr** %21
  call void (%Expr*) @print_stmt_expr (%Expr* %22)
  br label %endif_2
else_2:

;stmt12:
  %23 = icmp eq %StmtKind %9, 1
  br i1 %23, label %then_3, label %else_3
then_3:
...
;stmt14:
  %24 = getelementptr inbounds %Stmt, %Stmt* %0, i32 0, i32 4
...
;stmt17:
  %27 = getelementptr inbounds %Stmt, %Stmt* %0, i32 0, i32 1
...
;stmt20:
  %34 = getelementptr inbounds %Stmt, %Stmt* %0, i32 0, i32 6
  %35 = load %If*, %If** %34
...
;stmt23:
  %37 = getelementptr inbounds %Stmt, %Stmt* %0, i32 0, i32 5
...
;stmt26:
  %40 = getelementptr inbounds %Stmt, %Stmt* %0, i32 0, i32 1
...
;stmt35:
  %46 = getelementptr inbounds %Stmt, %Stmt* %0, i32 0, i32 7
  %47 = load %Str, %Str* %46
...
;stmt38:
  %49 = getelementptr inbounds %Stmt, %Stmt* %0, i32 0, i32 7
  %50 = load %Str, %Str* %49
...
;stmt39:
  %68 = load %Str, %Str* @_func320_str10
  store %Str %68, %Str* %20
  br label %endif_8
endif_8:
  br label %endif_7
...
;stmt42:
  %70 = load %Str, %Str* @_func320_str11
  store %Str %70, %Str* %20
  br label %endif_10
else_10:
...
;stmt48:
  %79 = load %Str, %Str* @_func320_str12
  store %Str %79, %Str* %20
  br label %endif_12
else_12:
...
;stmt51:
  %84 = load %Str, %Str* @_func320_str13
  store %Str %84, %Str* %20
  br label %endif_13
else_13:
...
;stmt53:
  %85 = load %Str, %Str* @_func320_str14
  store %Str %85, %Str* %20
  br label %endif_13
endif_13:
  br label %endif_12
...
;stmt57:
  %87 = load %Str, %Str* @_func320_str15
  %88 = call %Int32 (%Str, ...) @printf (%Str %87, %TypeKind %19)

;stmt58:
  %89 = load %Str, %Str* @_func320_str16
...
;stmt59:
  ...
  %91 = load %Str, %Str* @_func320_str17
  %92 = load %Str, %Str* %20
...
;stmt63:
  %95 = load %Str, %Str* @_func320_str18
...
;stmt83:
  ...
  %65 = load %Str, %Str* @_func321_str25
  %66 = load %Str, %Str* %2
...
;stmt12:
  ...
  %55 = load %Str, %Str* @_func329_str10
...
;stmt14:
  ...
  %58 = load %Str, %Str* @_func329_str11
...
;stmt33:
  %51 = load %Str, %Str* @_func331_str10
