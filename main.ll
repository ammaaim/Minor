...
@func356_str2 = private unnamed_addr constant [25 x i8] c"  -lib=/path/to/lib/dir\0A\00", align 1
@func356_str3 = private unnamed_addr constant [24 x i8] c"  -arch=x86, cortex-m3\0A\00", align 1
@func356_str4 = private unnamed_addr constant [16 x i8] c"  m2 <target>\0A\0A\00", align 1
...
;stmt1:
  %3 = bitcast [25 x %Nat8]* @func356_str2 to %Str
  %4 = call %Int32 (%Str, ...) @printf (%Str %3)

;stmt2:
  %5 = bitcast [24 x %Nat8]* @func356_str3 to %Str
  %6 = call %Int32 (%Str, ...) @printf (%Str %5)

;stmt3:
  %7 = bitcast [16 x %Nat8]* @func356_str4 to %Str
  %8 = call %Int32 (%Str, ...) @printf (%Str %7)
  ret void
}
