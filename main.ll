...
@func245_str1 = private unnamed_addr constant [18 x i8] c"expected function\00", align 1
...
;stmt4:
  %9 = bitcast [18 x %Nat8]* @func245_str1 to %Str
  %10 = load %Value*, %Value** %v
...
;stmt16:
  %23 = bitcast [2 x %Nat8]* @func266_str4 to %Str
