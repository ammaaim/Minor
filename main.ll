...
%NodeForeachHandler = type 
%NodeSearchHandler = type 
%ListForeachHandler = type 
%ListForeachHandler2 = type 
%ListCompareHandler = type 
%ListSearchHandler = type 
%ListMapHandler = type 
%List = type {%Node*, %Node*, %Nat64}
%Map = type {%Node*, %Node*, %Nat64}
%MapForeachHandler = type 
%TokenType = type %Int16
%TokenInfo = type {%Str, %Nat32, %Nat16, %Nat16}
%Token = type {%TokenType, %TokenInfo, }
%State = type {%Int32, %TokenType, , %Nat16, %Nat32, %Nat32, %Nat16, %Str, %Nat8}
%Rule = type 
...
%Value = type {%ValueKind, %Type*, %Storage, , %Str, %List*, %Block*, %Type*, %TokenInfo*, %TokenInfo*, %TokenInfo*}
%Block = type {%Block*, %List*, %List, %List, %List*}
%If = type {%Value*, %Stmt*, %Stmt*}
%While = type {%Value*, %Stmt*}
%StmtKind = type %Int16
%Stmt = type {%StmtKind, , %Block*, %VarDef*, %While*, %If*, %Str, %TokenInfo*}
...
@func139_str1 = private unnamed_addr constant [32 x i8] c"asm_func_rename: func not found\00", align 1
@func141_str1 = private unnamed_addr constant [34 x i8] c"asm_const_rename: const not found\00", align 1
...
;stmt1:
  %4 = call  @str_new (%Nat32 %3)

;stmt2:
  %5 = load %Str, %Str* %s
  %6 = call  @strcpy (%Str %4, %Str %5)
...
;stmt2:
  %3 = bitcast * @func7_str1 to %Str
  %4 = load %Str, %Str* %text
  %5 = call  @printf (%Str %3, %Str %4)
...
;stmt0:
  %1 = load %Str, %Str* %path
  %2 = call  @prepart (%Str %1)

;stmt1:
  %3 = add %Nat32 %2, 1
  %4 = call  @malloc (%Nat32 %3)
...
;stmt2:
  ...
  %9 = call  @memcpy (%Unit* %6, %Unit* %8, %Nat32 %2)
...
;stmt3:
  ...
  %13 = call  @memcpy (%Unit* %9, %Unit* %12, %Nat32 %5)
...
;stmt0:
  ...
  %3 = call  @memset (%Unit* %2, %Nat8 0, %Nat32 32)
  ret void
}
...
;stmt0:
  %1 = call  @malloc (%Nat32 32)
  %2 = bitcast %Unit* %1 to %Node*

;stmt1:
  call  @node_init (%Node* %2)
...
;stmt9:
  ...
  call  %11 (%Node* %12, %Unit* %13, %Nat32 %14)
...
;stmt9:
  ...
  %17 = call  %13 (%Node* %14, %Unit* %15, %Nat32 %16)
...
;stmt0:
  ...
  %3 = call  @node_search (%Node* %1, %NodeSearchHandler @func20, %Unit* %2)
  ret %Node* %3
}
...
;stmt0:
  ...
  %3 = call  @memset (%Unit* %2, %Nat8 0, %Nat32 24)
  ret void
}
...
;stmt0:
  %1 = call  @malloc (%Nat32 24)
  %2 = bitcast %Unit* %1 to %List*

;stmt1:
  call  @map_init (%List* %2)
...
;stmt9:
  ...
  call  @node_append (%Node* %23, %Node* %10)
  br label %endif_1
endif_1:
...
;stmt0:
  ...
  %3 = load %Node*, %Node** %2
  %4 = load %Unit*, %Unit** %o1
  %5 = call  @node_search_by_data (%Node* %3, %Unit* %4)
...
;stmt4:
  ...
  call  @list_node_remove (%List* %10, %Node* %5)
...
;stmt6:
  ...
  call  %8 (%Unit* %11, %Unit* %12, %Nat32 %13)
...
;stmt8:
  ...
  call  %16 (%Unit* %19, %Unit* %22, %Unit* %23, %Nat32 %24)
...
;stmt11:
  ...
  %33 = call  %24 (%Unit* %27, %Unit* %30, %Unit* %31, %Nat32 %32)
  %34 = xor %Bool %33, 1
...
;stmt9:
  ...
  %20 = call  %14 (%Unit* %17, %Unit* %18, %Nat32 %19)
...
;stmt10:
  ...
  %22 = call  %16 (%Unit* %19, %Unit* %20, %Nat32 %21)
...
;stmt13:
  %25 = call  @list_append (%List* %11, %Unit* %22)
  br label %endif_1
else_1:
  br label %endif_1
endif_1:
...
;stmt10:
  ...
  call  @node_append (%Node* %31, %Node* %15)
  br label %endif_1
endif_1:
...
;stmt0:
  ...
  %6 = call  @node_search (%Node* %3, %NodeSearchHandler @f, %Unit* %5)
  ret %Node* %6
}
...
;stmt0:
  %1 = load %List*, %List** %m
  %2 = load %Str, %Str* %k
  %3 = call  @map_list_node_get (%List* %1, %Str %2)
...
;stmt5:
  %11 = load %List*, %List** %m
  call  @list_node_remove (%List* %11, %Node* %3)
...
;stmt4:
  ...
  %15 = load %Unit*, %Unit** %ctx
  call  %8 (%Unit* %11, %Unit* %14, %Unit* %15)
...
;stmt2:
  %4 = bitcast * @func41_str1 to %Str
  %5 = load %Str, %Str* %fname
  %6 = call  @printf (%Str %4, %Str %5)

;stmt3:
  %7 = bitcast * @func41_str2 to %Str
  call  @fatal (%Str %7)
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt8:
  %14 = bitcast * @func41_str3 to %Str
  %15 = load %Str, %Str* %fname
  %16 = call  @cat3 (%Str %13, %Str %14, %Str %15)
...
;stmt6:
  ...
  %10 = call  @read (%Int32 %8, %Nat8* %9, %Nat32 1)
...
;stmt10:
  ...
  %11 = getelementptr inbounds , * %8, i32 0, %Nat32 %10 ; eval_index
  %12 = load %Nat8, %Nat8* %c
...
;stmt0:
  %1 = load %Nat8, %Nat8* %c
  %2 = bitcast * @func45_str1 to %Str
  %3 = getelementptr inbounds %Nat8, %Str %2, %Int32 0 ; eval_index
  %4 = load %Nat8, %Nat8* %3
  %5 = icmp eq %Nat8 %1, %4
  %6 = load %Nat8, %Nat8* %c
  %7 = bitcast * @func45_str2 to %Str
...
;stmt0:
  %1 = load %Nat8, %Nat8* %c
  %2 = bitcast * @func47_str1 to %Str
  %3 = getelementptr inbounds %Nat8, %Str %2, %Int32 0 ; eval_index
  %4 = load %Nat8, %Nat8* %3
  %5 = icmp eq %Nat8 %1, %4
  %6 = load %Nat8, %Nat8* %c
  %7 = bitcast * @func47_str2 to %Str
  %8 = getelementptr inbounds %Nat8, %Str %7, %Int32 0 ; eval_index
  %9 = load %Nat8, %Nat8* %8
  %10 = icmp eq %Nat8 %6, %9
  %11 = or %Bool %5, %10
...
;stmt0:
  %1 = load %Nat8, %Nat8* %c
  %2 = bitcast * @func48_str1 to %Str
  %3 = getelementptr inbounds %Nat8, %Str %2, %Int32 0 ; eval_index
  %4 = load %Nat8, %Nat8* %3
  %5 = icmp eq %Nat8 %1, %4
  %6 = load %Nat8, %Nat8* %c
  %7 = bitcast * @func48_str2 to %Str
  %8 = getelementptr inbounds %Nat8, %Str %7, %Int32 0 ; eval_index
  %9 = load %Nat8, %Nat8* %8
  %10 = icmp eq %Nat8 %6, %9
  %11 = or %Bool %5, %10
...
;stmt0:
  %1 = load %Nat8, %Nat8* %c
  %2 = bitcast * @func49_str1 to %Str
  %3 = getelementptr inbounds %Nat8, %Str %2, %Int32 0 ; eval_index
  %4 = load %Nat8, %Nat8* %3
  %5 = icmp eq %Nat8 %1, %4
  %6 = load %Nat8, %Nat8* %c
  %7 = bitcast * @func49_str2 to %Str
  %8 = getelementptr inbounds %Nat8, %Str %7, %Int32 0 ; eval_index
  %9 = load %Nat8, %Nat8* %8
  %10 = icmp eq %Nat8 %6, %9
  %11 = or %Bool %5, %10
...
;stmt0:
  %1 = load %Nat8, %Nat8* %c
  %2 = call  @isalnum (%Nat8 %1)
  %3 = load %Nat8, %Nat8* %c
  %4 = bitcast * @func52_str1 to %Str
...
;stmt15:
  ...
  %16 = getelementptr inbounds , * %15, i32 0, %Int32 0 ; eval_index
  %17 = load %Nat8, %Nat8* %c
...
;stmt17:
  %19 = load %Nat8, %Nat8* %c
  %20 = call  @isalpha (%Nat8 %19)
  %21 = load %Nat8, %Nat8* %c
  %22 = bitcast * @func54_str1 to %Str
...
;stmt35:
  call  @fill (%Rule @minus)
  br label %endif_6
else_6:

;stmt36:
  %48 = load %Nat8, %Nat8* %c
  %49 = bitcast * @func54_str5 to %Str
...
;stmt43:
  call  @fill (%Rule @rarrow)
  br label %endif_9
else_9:

;stmt44:
  %61 = load %Nat8, %Nat8* %c
  %62 = bitcast * @func54_str7 to %Str
...
;stmt46:
  call  @fill (%Rule @larrow)
  br label %endif_10
else_10:

;stmt47:
  %66 = load %Nat8, %Nat8* %c
  %67 = bitcast * @func54_str8 to %Str
...
;stmt54:
  %77 = load %Nat8, %Nat8* %c
  %78 = bitcast * @func54_str10 to %Str
...
;stmt60:
  ...
  %86 = getelementptr inbounds , * %85, i32 0, %Int32 0 ; eval_index
...
;stmt64:
  ...
  %92 = getelementptr inbounds , * %89, i32 0, %Nat32 %91 ; eval_index
...
;stmt14:
  ...
  %18 = getelementptr inbounds , * %17, i32 0, %Int32 0 ; eval_index
  %19 = bitcast * @func55_str3 to %Str
...
;stmt15:
  ...
  %23 = getelementptr inbounds , * %22, i32 0, %Int32 1 ; eval_index
...
;stmt38:
  call  @lex_putback (%Nat8 %1)

;stmt39:
  call  @fill (%Rule @slash)
  br label %endif_3
endif_3:
  br label %endif_0
endif_0:
...
;stmt25:
  %43 = load %Nat8, %Nat8* %c
  %44 = bitcast * @func56_str10 to %Str
  %45 = getelementptr inbounds %Nat8, %Str %44, %Int32 0 ; eval_index
  %46 = load %Nat8, %Nat8* %45
  %47 = icmp eq %Nat8 %43, %46
  br i1 %47, label %then_6, label %else_6
...
;stmt27:
  %48 = bitcast * @func56_str11 to %Str
  %49 = getelementptr inbounds %Nat8, %Str %48, %Int32 0 ; eval_index
  %50 = load %Nat8, %Nat8* %49
...
;stmt28:
  %51 = load %Nat8, %Nat8* %c
  %52 = bitcast * @func56_str12 to %Str
...
;stmt30:
  %56 = bitcast * @func56_str13 to %Str
...
;stmt31:
  %59 = load %Nat8, %Nat8* %c
  %60 = bitcast * @func56_str14 to %Str
...
;stmt33:
  %64 = bitcast * @func56_str15 to %Str
...
;stmt34:
  %67 = load %Nat8, %Nat8* %c
  %68 = bitcast * @func56_str16 to %Str
...
;stmt36:
  %72 = bitcast * @func56_str17 to %Str
  %73 = getelementptr inbounds %Nat8, %Str %72, %Int32 0 ; eval_index
  %74 = load %Nat8, %Nat8* %73
...
;stmt37:
  %75 = load %Nat8, %Nat8* %c
  %76 = bitcast * @func56_str18 to %Str
...
;stmt39:
  %80 = bitcast * @func56_str19 to %Str
...
;stmt40:
  %83 = load %Nat8, %Nat8* %c
  %84 = bitcast * @func56_str20 to %Str
...
;stmt45:
  %91 = bitcast * @func56_str21 to %Str
  call  @fatal (%Str %91)
  br label %endif_12
else_12:
  br label %endif_12
...
;stmt46:
  ...
  %95 = getelementptr inbounds , * %92, i32 0, %Nat32 %94 ; eval_index
  %96 = load %Nat8, %Nat8* %c
...
;stmt0:
  %1 = bitcast * @func59_str1 to %Str
  %2 = inttoptr %Nat32 0 to %Unit*
  %3 = bitcast %Unit* %2 to %TokenInfo*
  call  @error (%Str %1, %TokenInfo* %3)

;stmt1:
  %4 = bitcast * @func59_str2 to %Str
  %5 = call  @ctok ()
  %6 = getelementptr inbounds %Token, %Token* %5, i32 0, i32 2 ; eval_access
  %7 = call  @printf (%Str %4, * %6)

;stmt2:
  %8 = bitcast * @func59_str3 to %Str
  %9 = load %Str, %Str* %s
  %10 = call  @printf (%Str %8, %Str %9)
...
;stmt0:
  %1 = load %Nat8, %Nat8* %c
  %2 = bitcast * @func62_str1 to %Str
  %3 = getelementptr inbounds %Nat8, %Str %2, %Int32 0 ; eval_index
  %4 = load %Nat8, %Nat8* %3
  %5 = icmp uge %Nat8 %1, %4
  %6 = load %Nat8, %Nat8* %c
  %7 = bitcast * @func62_str2 to %Str
  %8 = getelementptr inbounds %Nat8, %Str %7, %Int32 0 ; eval_index
  %9 = load %Nat8, %Nat8* %8
  %10 = icmp ule %Nat8 %6, %9
  %11 = and %Bool %5, %10
...
;stmt0:
  %1 = load %Nat8, %Nat8* %c
  %2 = call  @isalpha (%Nat8 %1)
  %3 = load %Nat8, %Nat8* %c
  %4 = call  @isdigit (%Nat8 %3)
  %5 = or %Bool %2, %4
  ret %Bool %5
}
...
;stmt0:
  %1 = call  @malloc (%Nat32 512)

;stmt1:
  %2 = bitcast %Unit* %1 to %Str
  %3 = call  @getcwd (%Str %2, %Nat32 512)
  ret %Str %3
}
...
;stmt0:
  ...
  %4 = call  @list_append (%List* %1, %Unit* %3)
  ret void
}
...
;stmt0:
  %1 = load %Str, %Str* %dir
  %2 = bitcast * @func68_str1 to %Str
  %3 = load %Str, %Str* %resource
  %4 = call  @cat3 (%Str %1, %Str %2, %Str %3)

;stmt1:
  %5 = bitcast * @func68_str2 to %Str
  %6 = call  @cat (%Str %4, %Str %5)
...
;stmt7:
  %10 = call  @getprefix (%Str %6)
  %11 = call  @chdir (%Str %10)

;stmt8:
  %12 = call  @get_last (%Str %6)
  %13 = call  @tokenize (%Str %12)
...
;stmt11:
  %14 = bitcast * @func68_str3 to %Str
  %15 = call  @cat (%Str %4, %Str %14)

;stmt12:
  %16 = call  @exists (%Str %15)
...
;stmt14:
  ...
  %18 = call  @chdir (%Str %17)

;stmt15:
  %19 = bitcast * @func68_str4 to %Str
  %20 = call  @tokenize (%Str %19)
...
;stmt22:
  ...
  %31 = call  @src_new (%Str %29, %List* %30)
  ret %Source* %31
}
...
;stmt0:
  %1 = bitcast * @func69_str1 to %Str
  %2 = load %Str, %Str* %import_string
  %3 = call  @src_open (%Str %1, %Str %2)
...
;stmt8:
  ...
  %18 = call  @list_search (%List* %15, %ListSearchHandler @search_in_lib, %Unit* %17)
...
;stmt0:
  %1 = bitcast * @func71_str1 to %Str
  %2 = load %Str, %Str* %s
  %3 = call  @printf (%Str %1, %Int32 27, %Int32 36, %Int32 27, %Str %2)
  ret void
}
...
;stmt2:
  ...
  %12 = load %Str, %Str* %s
  %13 = call  @printf (%Str %5, %Int32 27, %Int32 34, %Int32 27, %Str %8, %Nat32 %11, %Str %12)

;stmt3:
  %14 = load %TokenInfo*, %TokenInfo** %ti
  call  @show (%TokenInfo* %14)

;stmt4:
  %15 = bitcast * @func72_str2 to %Str
  %16 = call  @printf (%Str %15)
  br label %endif_0
else_0:
...
;stmt6:
  %17 = bitcast * @func72_str3 to %Str
  %18 = load %Str, %Str* %s
  %19 = call  @printf (%Str %17, %Int32 27, %Int32 34, %Int32 27, %Str %18)
  br label %endif_0
endif_0:
...
;stmt2:
  %5 = bitcast * @func73_str1 to %Str
  %6 = load %Str, %Str* %s
  %7 = call  @printf (%Str %5, %Int32 27, %Int32 35, %Int32 27, %Str %6)
  br label %endif_0
else_0:
...
;stmt4:
  ...
  %14 = load %Nat32, %Nat32* %13
  %15 = load %Str, %Str* %s
  %16 = call  @printf (%Str %8, %Int32 27, %Int32 35, %Int32 27, %Str %11, %Nat32 %14, %Str %15)

;stmt5:
  %17 = load %TokenInfo*, %TokenInfo** %ti
  call  @show (%TokenInfo* %17)

;stmt6:
  %18 = bitcast * @func73_str3 to %Str
  %19 = call  @printf (%Str %18)
  br label %endif_0
endif_0:
...
;stmt10:
  %24 = bitcast * @func73_str4 to %Str
  %25 = call  @printf (%Str %24)
...
;stmt0:
  %1 = bitcast * @func74_str1 to %Str
  %2 = load %Str, %Str* %s
  %3 = call  @printf (%Str %1, %Int32 27, %Int32 33, %Str %2, %Int32 27)
...
;stmt3:
  ...
  call  @show (%TokenInfo* %8)

;stmt4:
  %9 = bitcast * @func74_str2 to %Str
  %10 = call  @printf (%Str %9)
  br label %endif_0
else_0:
  br label %endif_0
endif_0:
...
define void @gline ( %_line, %TokenInfo* %_ti) {
  %line = alloca 
  store  %_line, * %line
  %ti = alloca %TokenInfo*
  store %TokenInfo* %_ti, %TokenInfo** %ti
...
;stmt16:
  ...
  %13 = call  @read (%Int32 %4, %Nat8* %12, %Nat32 1)
...
;stmt19:
  ...
  %17 = load , * %line
  %18 = getelementptr inbounds %Nat8,  %17, %Nat32 %16 ; eval_index
  %19 = load %Nat8, %Nat8* %c
...
;stmt25:
  ...
  %29 = call  @read (%Int32 %4, %Nat8* %28, %Nat32 1)

;stmt26:
  %30 = load %Nat8, %Nat8* %c
  %31 = bitcast * @func75_str2 to %Str
...
;stmt30:
  %37 = call  @close (%Int32 %4)

;stmt31:
  %38 = load %Nat32, %Nat32* %pos
  %39 = load , * %line
  %40 = getelementptr inbounds %Nat8,  %39, %Nat32 %38 ; eval_index
  store %Nat8 0, %Nat8* %40
...
;stmt2:
  %3 = getelementptr inbounds , * %line, i32 0, %Int32 0 ; eval_index
  %4 = bitcast %Nat8* %3 to %Unit*
  %5 = call  @memset (%Unit* %4, %Nat8 0, %Nat32 512)

;stmt3:
  %6 = getelementptr inbounds , * %line, i32 0, %Int32 0 ; eval_index
  %7 = bitcast %Nat8* %6 to 
  %8 = load %TokenInfo*, %TokenInfo** %ti
  call  @gline ( %7, %TokenInfo* %8)

;stmt4:
  %9 = bitcast * @func76_str2 to %Str
  %10 = getelementptr inbounds , * %line, i32 0, %Int32 0 ; eval_index
  %11 = call  @printf (%Str %9, %Nat8* %10)
...
;stmt9:
  %17 = bitcast * @func76_str3 to %Str
  %18 = call  @printf (%Str %17)
...
;stmt11:
  %21 = bitcast * @func76_str4 to %Str
  %22 = call  @printf (%Str %21, %Int32 27, %Int32 32, %Int32 27)
  ret void
}
...
;stmt0:
  %1 = bitcast * @func77_str1 to %Str
  %2 = load %Str, %Str* %s
  %3 = call  @printf (%Str %1, %Int32 27, %Int32 31, %Int32 27, %Str %2)
...
;stmt1:
  ...
  %5 = icmp ne %Unit* %3, %4
  %6 = bitcast * @func78_str1 to %Str
  call  @assert (%Bool %5, %Str %6)

;stmt2:
  %7 = bitcast %Type* %2 to %Unit*
  %8 = call  @memset (%Unit* %7, %Nat8 0, %Nat32 184)
...
;stmt3:
  call  @type_undefined_check (%Type* %4)
...
;stmt6:
  ...
  %20 = load %Nat8, %Nat8* %19
  %21 = call  @alignment (%Nat32 %18, %Nat8 %20)
  %22 = add %Nat32 %16, %21
...
;stmt7:
  ...
  call  @list_foreach (%List* %15, %ListForeachHandler @fpost, %Unit* %17)
...
;stmt0:
  ...
  %6 = bitcast %Str %5 to %Unit*
  %7 = call  @list_search (%List* %4, %ListSearchHandler @fsearch2, %Unit* %6)
...
;stmt5:
  ...
  %16 = call  @type_eq (%Type* %13, %Type* %15)
  ret %Bool %16
}
...
;stmt0:
  ...
  %6 = load %List*, %List** %5
  %7 = inttoptr %Nat32 0 to %Unit*
  %8 = call  @list_compare (%List* %3, %List* %6, %ListCompareHandler @check_fields, %Unit* %7)
  ret %Bool %8
}
...
;stmt3:
  ...
  call  @list_foreach (%List* %9, %ListForeachHandler @create_constructor, %Unit* %10)
...
;stmt0:
  %1 = call  @type_new (%TypeKind 4)

;stmt1:
  %2 = getelementptr inbounds %Type, %Type* %1, i32 0, i32 2 ; eval_access
  %3 = bitcast * @func95_str1 to %Str
  %4 = call  @get (%Str %3)
...
;stmt7:
  ...
  %27 = call  @type_eq (%Type* %24, %Type* %26)
  ret %Bool %27
}
...
;stmt3:
  ...
  %17 = call  @list_compare (%List* %12, %List* %15, %ListCompareHandler @check_param, %Unit* %16)
  ret %Bool %17
}
...
;stmt7:
  ...
  %15 = load %Type*, %Type** %14
  call  @type_undefined_check (%Type* %15)
  br label %endif_2
endif_2:
  br label %endif_1
else_1:
...
;stmt10:
  ...
  call  @type_undefined_check (%Type* %21)
  br label %endif_3
else_3:

;stmt11:
  %22 = load %Type*, %Type** %t
  %23 = call  @type_is_function (%Type* %22)
...
;stmt13:
  ...
  call  @type_undefined_check (%Type* %27)
...
;stmt14:
  ...
  call  @list_foreach (%List* %31, %ListForeachHandler @foreach_func_param, %Unit* %32)
  br label %endif_4
else_4:

;stmt15:
  %33 = load %Type*, %Type** %t
  %34 = call  @type_is_record (%Type* %33)
...
;stmt17:
  ...
  call  @list_foreach (%List* %38, %ListForeachHandler @foreach_struct_field, %Unit* %39)
  br label %endif_5
else_5:

;stmt18:
  %40 = load %Type*, %Type** %t
  %41 = call  @type_is_enum (%Type* %40)
...
;stmt11:
  ...
  %39 = call  @type_basic_eq (%TypeBasic* %36, %TypeBasic* %38)
  ret %Bool %39
  br label %endif_3
else_3:
...
;stmt14:
  ...
  %46 = call  @type_pointer_eq (%TypePointer* %43, %TypePointer* %45)
  ret %Bool %46
  br label %endif_4
else_4:
...
;stmt17:
  ...
  %53 = call  @type_array_eq (%TypeArray* %50, %TypeArray* %52)
  ret %Bool %53
  br label %endif_5
else_5:
...
;stmt20:
  ...
  %60 = call  @type_function_eq (%TypeFunc* %57, %TypeFunc* %59)
  ret %Bool %60
  br label %endif_6
else_6:
...
;stmt23:
  ...
  %67 = call  @type_record_eq (%TypeRecord* %64, %TypeRecord* %66)
  ret %Bool %67
  br label %endif_7
else_7:
...
;stmt26:
  ...
  %74 = call  @type_enum_eq (%TypeEnum* %71, %TypeEnum* %73)
  ret %Bool %74
  br label %endif_8
else_8:
...
;stmt30:
  %82 = bitcast * @func101_str1 to %Str
  call  @assert (%Bool 0, %Str %82)
...
;stmt2:
  %5 = load %Str, %Str* %id
  call  @bind_type_global (%Str %5, %Type* %1)
...
;stmt1:
  ...
  %4 = inttoptr %Nat32 0 to %Unit*
  %5 = icmp ne %Unit* %3, %4
  %6 = bitcast * @func115_str1 to %Str
  call  @assert (%Bool %5, %Str %6)

;stmt2:
  %7 = bitcast %Value* %2 to %Unit*
  %8 = call  @memset (%Unit* %7, %Nat8 0, %Nat32 144)
...
;stmt5:
  ...
  %15 = getelementptr inbounds , * %14, i32 0, %Int32 1 ; eval_index
...
;stmt0:
  ...
  %3 = call  @storage_is_const (%Storage* %2)
  ret %Bool %3
}
...
;stmt0:
  ...
  %2 = call  @value_new_imm_const (%Type* %1, %Int64 0)

;stmt1:
  %3 = load %Type*, %Type** @typeFreePtr
  %4 = inttoptr %Nat32 0 to %Unit*
  %5 = bitcast %Unit* %4 to %Value*
  %6 = call  @value_new_register (%ValueKind 25, %Type* %3, %Value* %2, %Value* %5)
...
;stmt0:
  ...
  %5 = call  @value_new (%ValueKind %1, %Type* %2, %Value* %3, %Value* %4)
...
;stmt0:
  ...
  %4 = inttoptr %Nat32 0 to %Unit*
  %5 = bitcast %Unit* %4 to %Value*
  %6 = call  @value_new (%ValueKind 1, %Type* %1, %Value* %3, %Value* %5)
...
;stmt0:
  %1 = load %Value*, %Value** %v
  %2 = getelementptr inbounds %Value, %Value* %1, i32 0, i32 2 ; eval_access
  %3 = call  @storageIsMutable (%Storage* %2)
  %4 = xor %Bool %3, 1
  ret %Bool %4
}
...
;stmt0:
  ...
  %18 = call  @isReletionOpKind (%ValueKind %17)
  %19 = or %Bool %16, %18
  %20 = or %Bool %14, %19
  %21 = or %Bool %12, %20
  %22 = or %Bool %10, %21
...
;stmt20:
  %38 = call  @isBinaryOpKind (%ValueKind %17)
...
;stmt22:
  ...
  %40 = call  @getTypeBinary (%Value* %39)
  store %Type* %40, %Type** %t
  br label %endif_4
else_4:

;stmt23:
  %41 = call  @isUnaryOpKind (%ValueKind %17)
...
;stmt34:
  ...
  %52 = call  @getTypeAccess (%Value* %51)
...
;stmt44:
  %66 = bitcast * @func125_str2 to %Str
  call  @assert (%Bool 0, %Str %66)
...
;stmt1:
  ...
  %5 = inttoptr %Nat32 0 to %Unit*
  %6 = icmp ne %Unit* %4, %5
  %7 = bitcast * @func128_str1 to %Str
  call  @assert (%Bool %6, %Str %7)
...
;stmt2:
  ...
  %10 = inttoptr %Nat32 0 to %Unit*
  %11 = icmp ne %Unit* %9, %10
  %12 = bitcast * @func128_str2 to %Str
  call  @assert (%Bool %11, %Str %12)
...
;stmt5:
  %16 = load %Type*, %Type** %t
  %17 = call  @type_is_basic_integer (%Type* %16)
  br i1 %17, label %then_1, label %else_1
then_1:
...
;stmt7:
  ...
  %23 = call  @value_new_imm_const (%Type* %18, %Int64 %22)
  ret %Value* %23
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt8:
  ...
  %27 = load %Type*, %Type** %26
  %28 = load %Type*, %Type** %t
  %29 = call  @naturalConversionIsPossible (%Type* %27, %Type* %28)
  br i1 %29, label %then_2, label %else_2
then_2:
...
;stmt10:
  ...
  %35 = call  @cast (%Value* %30, %Type* %31, %TokenInfo* %34)

;stmt11:
  %36 = call  @getType (%Value* %35)
...
;stmt9:
  ...
  %26 = call  @type_eq (%Type* %24, %Type* %25)
  br i1 %26, label %then_3, label %else_3
then_3:
...
;stmt12:
  ...
  %30 = call  @type_eq (%Type* %28, %Type* %29)
...
;stmt17:
  ...
  %41 = call  @type_eq (%Type* %39, %Type* %40)
  %42 = and %Bool %38, %41
...
;stmt22:
  ...
  %53 = call  @type_eq (%Type* %51, %Type* %52)
  %54 = and %Bool %50, %53
  br i1 %54, label %then_8, label %else_8
then_8:
...
;stmt1:
  ...
  %4 = inttoptr %Nat32 0 to %Unit*
  %5 = icmp ne %Unit* %3, %4
  %6 = bitcast * @func130_str1 to %Str
  call  @assert (%Bool %5, %Str %6)

;stmt2:
  %7 = bitcast %Stmt* %2 to %Unit*
  %8 = call  @memset (%Unit* %7, %Nat8 0, %Nat32 72)
...
;stmt4:
  ...
  %15 = call  @list_append (%List* %13, %Unit* %14)
...
;stmt5:
  ...
  %17 = call  @list_append (%List* %15, %Unit* %16)
...
;stmt0:
  ...
  %5 = bitcast %Str %4 to %Unit*
  %6 = call  @list_search (%List* %3, %ListSearchHandler @search_func_by_id, %Unit* %5)
...
;stmt1:
  ...
  %9 = inttoptr %Nat32 0 to %Unit*
  %10 = icmp ne %Unit* %8, %9
  %11 = bitcast * @func139_str1 to %Str
  call  @assert (%Bool %10, %Str %11)
...
;stmt0:
  ...
  %4 = load %Str, %Str* %id_from
  %5 = bitcast %Str %4 to %Unit*
  %6 = call  @list_search (%List* %3, %ListSearchHandler @search_const_by_id, %Unit* %5)
...
;stmt1:
  ...
  %9 = inttoptr %Nat32 0 to %Unit*
  %10 = icmp ne %Unit* %8, %9
  %11 = bitcast * @func141_str1 to %Str
  call  @assert (%Bool %10, %Str %11)
...
;stmt8:
  %11 = bitcast * @func143_str3 to %Str
  ret %Str %11
  br label %endif_2
else_2:
...
;stmt11:
  %15 = bitcast * @func143_str4 to %Str
  ret %Str %15
  br label %endif_3
else_3:
...
;stmt14:
  %19 = bitcast * @func143_str5 to %Str
  ret %Str %19
  br label %endif_4
else_4:
...
;stmt17:
  %23 = bitcast * @func143_str6 to %Str
  ret %Str %23
  br label %endif_5
else_5:
...
;stmt20:
  %27 = bitcast * @func143_str7 to %Str
  ret %Str %27
  br label %endif_6
else_6:
...
;stmt23:
  %31 = bitcast * @func143_str8 to %Str
  ret %Str %31
  br label %endif_7
else_7:
...
;stmt26:
  %35 = bitcast * @func143_str9 to %Str
  ret %Str %35
  br label %endif_8
else_8:
...
;stmt29:
  %39 = bitcast * @func143_str10 to %Str
  ret %Str %39
  br label %endif_9
else_9:
...
;stmt32:
  %43 = bitcast * @func143_str11 to %Str
  ret %Str %43
  br label %endif_10
else_10:
...
;stmt35:
  %47 = bitcast * @func143_str12 to %Str
  ret %Str %47
  br label %endif_11
else_11:
...
;stmt38:
  %51 = bitcast * @func143_str13 to %Str
  ret %Str %51
  br label %endif_12
else_12:
...
;stmt41:
  %55 = bitcast * @func143_str14 to %Str
  ret %Str %55
  br label %endif_13
else_13:
...
;stmt44:
  %59 = bitcast * @func143_str15 to %Str
  ret %Str %59
  br label %endif_14
else_14:
...
;stmt47:
  %63 = bitcast * @func143_str16 to %Str
  ret %Str %63
  br label %endif_15
else_15:
...
;stmt50:
  %67 = bitcast * @func143_str17 to %Str
  ret %Str %67
  br label %endif_16
else_16:
...
;stmt53:
  %71 = bitcast * @func143_str18 to %Str
  ret %Str %71
  br label %endif_17
else_17:
...
;stmt56:
  %75 = bitcast * @func143_str19 to %Str
  ret %Str %75
  br label %endif_18
else_18:
...
;stmt59:
  %79 = bitcast * @func143_str20 to %Str
  ret %Str %79
  br label %endif_19
else_19:
...
;stmt62:
  %83 = bitcast * @func143_str21 to %Str
  ret %Str %83
  br label %endif_20
else_20:
...
;stmt65:
  %87 = bitcast * @func143_str22 to %Str
  ret %Str %87
  br label %endif_21
else_21:
...
;stmt68:
  %91 = bitcast * @func143_str23 to %Str
  ret %Str %91
  br label %endif_22
else_22:
...
;stmt71:
  %95 = bitcast * @func143_str24 to %Str
  ret %Str %95
  br label %endif_23
else_23:
...
;stmt74:
  %99 = bitcast * @func143_str25 to %Str
  ret %Str %99
  br label %endif_24
else_24:
...
;stmt77:
  %103 = bitcast * @func143_str26 to %Str
  ret %Str %103
  br label %endif_25
else_25:
  br label %endif_25
...
;stmt78:
  %105 = bitcast * @func143_str27 to %Str
  ret %Str %105
}
...
;stmt8:
  %11 = bitcast * @func144_str3 to %Str
  ret %Str %11
  br label %endif_2
else_2:
...
;stmt11:
  %15 = bitcast * @func144_str4 to %Str
  ret %Str %15
  br label %endif_3
else_3:
...
;stmt14:
  %19 = bitcast * @func144_str5 to %Str
  ret %Str %19
  br label %endif_4
else_4:
...
;stmt17:
  %23 = bitcast * @func144_str6 to %Str
  ret %Str %23
  br label %endif_5
else_5:
...
;stmt20:
  %27 = bitcast * @func144_str7 to %Str
  ret %Str %27
  br label %endif_6
else_6:
...
;stmt23:
  %31 = bitcast * @func144_str8 to %Str
  ret %Str %31
  br label %endif_7
else_7:
  br label %endif_7
...
;stmt24:
  %33 = bitcast * @func144_str9 to %Str
  ret %Str %33
}
...
;stmt0:
  %1 = bitcast * @func145_str1 to %Str
  %2 = load %Value*, %Value** %v
  %3 = call  @printf (%Str %1, %Value* %2)

;stmt1:
  %4 = bitcast * @func145_str2 to %Str
  %5 = load %Value*, %Value** %v
  %6 = getelementptr inbounds %Value, %Value* %5, i32 0, i32 0 ; eval_access
  %7 = load %ValueKind, %ValueKind* %6
  %8 = call  @print_value_kind (%ValueKind %7)
  %9 = call  @printf (%Str %4, %Str %8)

;stmt2:
  %10 = bitcast * @func145_str3 to %Str
  %11 = call  @printf (%Str %10)

;stmt3:
  %12 = load %Value*, %Value** %v
  %13 = getelementptr inbounds %Value, %Value* %12, i32 0, i32 1 ; eval_access
  %14 = load %Type*, %Type** %13
  call  @prttype (%Type* %14)

;stmt4:
  %15 = bitcast * @func145_str4 to %Str
  %16 = call  @printf (%Str %15)

;stmt5:
  %17 = bitcast * @func145_str5 to %Str
  ...
  %22 = call  @print_storage_class (%StorageClass %21)
  %23 = call  @printf (%Str %17, %Str %22)

;stmt6:
  %24 = bitcast * @func145_str6 to %Str
  %25 = load %Value*, %Value** %v
  ...
  %28 = load %Str, %Str* %27
  %29 = call  @printf (%Str %24, %Str %28)

;stmt7:
  %30 = bitcast * @func145_str7 to %Str
  ...
  %35 = call  @printf (%Str %30, %Nat32 %34)

;stmt8:
  %36 = bitcast * @func145_str8 to %Str
  ...
  %41 = call  @printf (%Str %36, %Int64 %40)

;stmt9:
  %42 = bitcast * @func145_str9 to %Str
  %43 = call  @printf (%Str %42)
  ret void
}
...
;stmt7:
  %17 = bitcast * @func146_str2 to %Str
  %18 = load %Type*, %Type** %t
...
;stmt10:
  %24 = bitcast * @func146_str3 to %Str
  %25 = call  @printf (%Str %24)
...
;stmt17:
  %33 = load %Type*, %Type** %t
  call  @print_type_record (%Type* %33)
  br label %endif_4
else_4:
...
;stmt23:
  ...
  call  @print_type_func (%TypeFunc* %38)
  br label %endif_6
else_6:
...
;stmt26:
  %40 = bitcast * @func146_str4 to %Str
  %41 = load %Type*, %Type** %t
...
;stmt29:
  %47 = bitcast * @func146_str5 to %Str
  %48 = call  @printf (%Str %47)
  br label %endif_8
else_8:
...
;stmt31:
  %49 = bitcast * @func146_str6 to %Str
  %50 = call  @printf (%Str %49, %TypeKind %15)
...
;stmt1:
  ...
  %10 = load %Type*, %Type** %9
  call  @prttype (%Type* %10)

;stmt2:
  %11 = bitcast * @func148_str2 to %Str
  %12 = call  @printf (%Str %11)
  ret void
}
...
;stmt1:
  ...
  %6 = load %List*, %List** %5
  %7 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %6, %ListForeachHandler @print_field, %Unit* %7)

;stmt2:
  %8 = bitcast * @func147_str2 to %Str
  %9 = call  @printf (%Str %8)

;stmt3:
  %10 = bitcast * @func147_str3 to %Str
  %11 = load %Type*, %Type** %t
  ...
  %14 = load %Nat32, %Nat32* %13
  %15 = call  @printf (%Str %10, %Nat32 %14)
  ret void
}
...
;stmt1:
  ...
  %6 = load %List*, %List** %5
  %7 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %6, %ListForeachHandler @print_cons, %Unit* %7)

;stmt2:
  %8 = bitcast * @func149_str2 to %Str
  %9 = call  @printf (%Str %8)
  ret void
}
...
;stmt2:
  ...
  %5 = load %List*, %List** %4
  %6 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %5, %ListForeachHandler @print_params, %Unit* %6)

;stmt3:
  %7 = bitcast * @func152_str2 to %Str
  %8 = call  @printf (%Str %7)
...
;stmt1:
  %4 = bitcast * @func155_str1 to %Str
  %5 = load %Unit*, %Unit** %k
  %6 = call  @printf (%Str %4, %Unit* %5)
...
;stmt6:
  %10 = bitcast * @func155_str2 to %Str
  %11 = call  @printf (%Str %10)
...
;stmt9:
  call  @prttype (%Type* %15)

;stmt10:
  %16 = bitcast * @func155_str3 to %Str
  %17 = call  @printf (%Str %16)
  ret void
}
...
;stmt0:
  ...
  %2 = inttoptr %Nat32 0 to %Unit*
  call  @map_foreach (%List* %1, %MapForeachHandler @shwt, %Unit* %2)
  ret void
}
...
;stmt6:
  %10 = bitcast * @func157_str2 to %Str
  %11 = call  @printf (%Str %10)
...
;stmt8:
  ...
  call  @prttype (%Type* %17)

;stmt9:
  %18 = bitcast * @func157_str3 to %Str
  %19 = call  @printf (%Str %18)
  ret void
}
...
;stmt0:
  ...
  %2 = inttoptr %Nat32 0 to %Unit*
  call  @map_foreach (%List* %1, %MapForeachHandler @shwv, %Unit* %2)
  ret void
}
...
;stmt0:
  %1 = getelementptr inbounds %ModuleContext, %ModuleContext* @mctx, i32 0, i32 2 ; eval_access
  %2 = inttoptr %Nat32 0 to %Unit*
  call  @map_foreach (%List* %1, %MapForeachHandler @chk, %Unit* %2)
  ret void
}
...
;stmt6:
  ...
  %12 = call  @map_append (%List* %9, %Str %10, %Unit* %11)
  br label %endif_0
else_0:
...
;stmt8:
  ...
  call  @map_reset (%List* %13, %Str %14, %Unit* %15)
  br label %endif_0
endif_0:
  ret void
}
...
;stmt16:
  %11 = call  @dolet (%Bool 0)
  br label %endif_1
else_1:

;stmt17:
  %12 = bitcast * @func163_str3 to %Str
  %13 = call  @match (%Str %12)
...
;stmt20:
  %14 = bitcast * @func163_str4 to %Str
  %15 = call  @match (%Str %14)
...
;stmt23:
  %16 = bitcast * @func163_str5 to %Str
  %17 = call  @match (%Str %16)
...
;stmt27:
  %18 = bitcast * @func163_str6 to %Str
  %19 = call  @match (%Str %18)
...
;stmt29:
  %20 = bitcast * @func163_str7 to %Str
  call  @set (%Str %20, %Nat64 1)
...
;stmt31:
  %22 = bitcast * @func163_str8 to %Str
  %23 = call  @match (%Str %22)
...
;stmt43:
  %34 = bitcast * @func163_str10 to %Str
  %35 = getelementptr inbounds %Token, %Token* %30, i32 0, i32 2 ; eval_access
  %36 = bitcast * %35 to %Str
  %37 = call  @strcmp (%Str %34, %Str %36)
  %38 = icmp eq %Int32 %37, 0
  %39 = bitcast * @func163_str11 to %Str
  %40 = getelementptr inbounds %Token, %Token* %30, i32 0, i32 2 ; eval_access
  %41 = bitcast * %40 to %Str
  %42 = call  @strcmp (%Str %39, %Str %41)
  %43 = icmp eq %Int32 %42, 0
  %44 = bitcast * @func163_str12 to %Str
  %45 = getelementptr inbounds %Token, %Token* %30, i32 0, i32 2 ; eval_access
  %46 = bitcast * %45 to %Str
  %47 = call  @strcmp (%Str %44, %Str %46)
...
;stmt50:
  %56 = bitcast * @func163_str13 to %Str
  call  @set (%Str %56, %Nat64 0)
  br label %continue_1
break_1:
...
;stmt5:
  ...
  %11 = getelementptr inbounds , * %10, i32 0, %Int32 0 ; eval_index
  %12 = bitcast %Nat8* %11 to %Str
  %13 = call  @dup (%Str %12)
...
;stmt7:
  %14 = call  @str_new (%Nat32 512)

;stmt8:
  %15 = call  @getcwd (%Str %14, %Nat32 512)

;stmt9:
  %16 = call  @source_open (%Str %13)
...
;stmt12:
  %20 = bitcast * @func164_str2 to %Str
  %21 = call  @printf (%Str %20, %Str %13)

;stmt13:
  %22 = bitcast * @func164_str3 to %Str
  call  @fatal (%Str %22)
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt14:
  call  @parse (%Source* %16)

;stmt15:
  %23 = call  @chdir (%Str %14)
...
;stmt21:
  ...
  %39 = call  @memcpy (%Unit* %36, %Unit* %38, %Nat32 184)

;stmt22:
  %40 = getelementptr inbounds %Assembly, %Assembly* @asm0, i32 0 ; ref
  %41 = load %Type*, %Type** %t
  %42 = call  @asm_typedef_add (%Assembly* %40, %Str %1, %Type* %41)
...
;stmt24:
  %44 = load %Type*, %Type** %t
  call  @bind_type_global (%Str %1, %Type* %44)

;stmt25:
  %45 = getelementptr inbounds %Assembly, %Assembly* @asm0, i32 0 ; ref
  %46 = load %Type*, %Type** %t
  %47 = call  @asm_typedef_add (%Assembly* %45, %Str %1, %Type* %46)
  ret void
}
...
;stmt5:
  ...
  %14 = call  @create_local_var (%Str %4, %Type* %6, %Value* %13)
  br label %endif_0
else_0:
...
;stmt7:
  ...
  call  @create_global_var (%Str %4, %Type* %6, %Value* %16)
  br label %endif_0
endif_0:
  ret void
}
...
;stmt1:
  %2 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %1, %ListForeachHandler @handle_fields, %Unit* %2)
  ret void
}
...
;stmt11:
  call  @def_global (%Str %3, %Value* %6, %TokenInfo* %2)
...
;stmt13:
  %23 = call  @value_is_const (%Value* %6)
  %24 = xor %Bool %23, 1
  br i1 %24, label %then_2, label %else_2
then_2:
...
;stmt15:
  ...
  %31 = call  @value_new_register (%ValueKind 1, %Type* %26, %Value* %28, %Value* %30)
...
;stmt17:
  %34 = call  @stmt_new_let (%Value* %6, %Value* %31)
...
;stmt19:
  call  @bind_value_local (%Str %3, %Value* %31)
...
;stmt21:
  ...
  call  @bind_value_in_block (%Block* %38, %Str %3, %Value* %6)
...
;stmt1:
  ...
  call  @declare (%Str %4, %Type* %6, %TokenInfo* %8)
  ret void
}
...
;stmt1:
  %2 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %1, %ListForeachHandler @extern_decl, %Unit* %2)
  ret void
}
...
;stmt8:
  br label %continue_0
continue_0:
  %14 = bitcast * @func171_str1 to %Str
  %15 = call  @match (%Str %14)
  %16 = xor %Bool %15, 1
  br i1 %16, label %body_0, label %break_0
body_0:
...
;stmt13:
  %18 = bitcast * @func171_str2 to %Str
  call  @fatal (%Str %18)
...
;stmt15:
  %20 = bitcast * @func171_str3 to %Str
  %21 = call  @match (%Str %20)
  br i1 %21, label %then_1, label %else_1
then_1:
...
;stmt3:
  %5 = bitcast * @func172_str1 to %Str
  %6 = getelementptr inbounds %Token, %Token* %1, i32 0, i32 1 ; eval_access
  call  @error (%Str %5, %TokenInfo* %6)

;stmt4:
  %7 = bitcast * @func172_str2 to %Str
  %8 = getelementptr inbounds %Token, %Token* %1, i32 0, i32 0 ; eval_access
  %9 = load %TokenType, %TokenType* %8
  %10 = call  @printf (%Str %7, %TokenType %9)

;stmt5:
  %11 = bitcast * @func172_str3 to %Str
  %12 = getelementptr inbounds %Token, %Token* %1, i32 0, i32 2 ; eval_access
  %13 = getelementptr inbounds , * %12, i32 0, %Int32 0 ; eval_index
  %14 = load %Nat8, %Nat8* %13
  %15 = call  @printf (%Str %11, %Nat8 %14)

;stmt6:
  %16 = bitcast * @func172_str4 to %Str
  %17 = getelementptr inbounds %Token, %Token* %1, i32 0, i32 2 ; eval_access
  %18 = bitcast * %17 to %Str
  %19 = call  @printf (%Str %16, %Str %18)
...
;stmt8:
  ...
  %27 = add %Nat32 %26, 1
  %28 = call  @str_new (%Nat32 %27)

;stmt9:
  %29 = getelementptr inbounds %Token, %Token* %1, i32 0, i32 2 ; eval_access
  %30 = bitcast * %29 to %Str
  %31 = call  @strcpy (%Str %28, %Str %30)
...
;stmt5:
  ...
  %7 = call  @field_new (%Str %4, %Type* %6, %TokenInfo* %3)

;stmt6:
  %8 = bitcast %Field* %7 to %Unit*
  %9 = call  @list_append (%List* %1, %Unit* %8)

;stmt7:
  %10 = bitcast * @func173_str1 to %Str
  %11 = call  @match (%Str %10)
  %12 = xor %Bool %11, 1
  br i1 %12, label %then_0, label %else_0
then_0:
...
;stmt11:
  %14 = bitcast * @func173_str2 to %Str
  %15 = call  @need (%Str %14)

;stmt12:
  %16 = call  @parse_type (%Bool 1)
...
;stmt16:
  ...
  call  @list_foreach (%List* %1, %ListForeachHandler @set_type, %Unit* %21)
...
;stmt1:
  %5 = bitcast * @func180_str1 to %Str
  %6 = getelementptr inbounds %Nat8, %Str %5, %Int32 0 ; eval_index
  %7 = load %Nat8, %Nat8* %6
  %8 = icmp eq %Nat8 %4, %7
  %9 = bitcast * @func180_str2 to %Str
...
;stmt4:
  ...
  %12 = bitcast * %11 to %Str
  %13 = call  @strcmp (%Str %10, %Str %12)
  %14 = icmp eq %Int32 %13, 0
...
;stmt3:
  %11 = load %Str, %Str* %id
  %12 = call  @get_value_global (%Str %11)
...
;stmt6:
  %16 = bitcast * @func184_str1 to %Str
  %17 = load %TokenInfo*, %TokenInfo** %ti
  call  @error (%Str %16, %TokenInfo* %17)

;stmt7:
  %18 = bitcast * @func184_str2 to %Str
  %19 = getelementptr inbounds %Value, %Value* %12, i32 0, i32 9 ; eval_access
  %20 = load %TokenInfo*, %TokenInfo** %19
  call  @rem (%Str %18, %TokenInfo* %20)
...
;stmt9:
  ...
  %27 = call  @value_new (%ValueKind 1, %Type* %22, %Value* %24, %Value* %26)
...
;stmt16:
  ...
  %47 = call  @asm_funcdef_add (%Assembly* %42, %Str %43, %Type* %44, %Block* %46)
  br label %endif_2
else_2:
  br label %endif_2
endif_2:
...
;stmt17:
  %48 = load %Str, %Str* %id
  call  @bind_value_global (%Str %48, %Value* %27)
  ret void
}
...
;stmt0:
  ...
  %3 = inttoptr %Nat32 0 to %Unit*
  %4 = icmp ne %Unit* %2, %3
  %5 = bitcast * @func185_str1 to %Str
  call  @assert (%Bool %4, %Str %5)
...
;stmt1:
  ...
  %8 = inttoptr %Nat32 0 to %Unit*
  %9 = icmp ne %Unit* %7, %8
  %10 = bitcast * @func185_str2 to %Str
  call  @assert (%Bool %9, %Str %10)
...
;stmt3:
  %14 = load %Str, %Str* %id
  %15 = call  @get_value_global (%Str %14)
...
;stmt12:
  %37 = load %Value*, %Value** %v
  %38 = load %Str, %Str* %id
  call  @rename (%Value* %37, %Str %38)

;stmt13:
  %39 = load %Str, %Str* %id
  %40 = load %Value*, %Value** %v
  call  @bind_value_global (%Str %39, %Value* %40)
  ret void
}
...
;stmt6:
  ...
  call  @asm_func_rename (%Assembly* %15, %Str %11, %Str %2)
  br label %endif_0
else_0:
...
;stmt9:
  ...
  %19 = getelementptr inbounds , * %18, i32 0, %Int32 0 ; eval_index
...
;stmt10:
  ...
  %26 = getelementptr inbounds , * %25, i32 0, %Int32 0 ; eval_index
...
;stmt11:
  ...
  call  @asm_const_rename (%Assembly* %30, %Str %23, %Str %2)
  br label %endif_1
else_1:
  br label %endif_1
endif_1:
...
;stmt0:
  ...
  %4 = load %Str, %Str* %id
  %5 = load %Type*, %Type** %t
  call  @add_type (%List* %3, %Str %4, %Type* %5)
  ret void
}
...
;stmt0:
  ...
  %2 = load %Str, %Str* %id
  %3 = load %Type*, %Type** %t
  call  @add_type (%List* %1, %Str %2, %Type* %3)
  ret void
}
...
;stmt0:
  ...
  %3 = load %Type*, %Type** %t
  %4 = bitcast %Type* %3 to %Unit*
  %5 = call  @map_append (%List* %1, %Str %2, %Unit* %4)
  ret void
}
...
;stmt4:
  ...
  %15 = call  @map_append (%List* %11, %Str %12, %Unit* %14)
  ret void
}
...
;stmt8:
  ...
  %16 = load %Str, %Str* %id
  %17 = call  @map_get (%List* %15, %Str %16)
...
;stmt13:
  ...
  %27 = load %Str, %Str* %id
  %28 = call  @map_get (%List* %26, %Str %27)
...
;stmt3:
  %6 = load %Str, %Str* %id
  %7 = load %Value*, %Value** %v
  call  @bind_value_in_block (%Block* %2, %Str %6, %Value* %7)
  br label %endif_0
else_0:
...
;stmt5:
  ...
  call  @bind_value_global (%Str %8, %Value* %9)
  br label %endif_0
endif_0:
  ret void
}
...
;stmt0:
  ...
  %6 = call  @map_append (%List* %2, %Str %3, %Unit* %5)
...
;stmt0:
  ...
  %4 = load %Str, %Str* %id
  %5 = load %Value*, %Value** %v
  call  @add_value (%List* %3, %Str %4, %Value* %5)
  ret void
}
...
;stmt0:
  ...
  %2 = load %Str, %Str* %id
  %3 = load %Value*, %Value** %v
  call  @add_value (%List* %1, %Str %2, %Value* %3)
  ret void
}
...
;stmt9:
  %15 = load %Str, %Str* %id
  %16 = call  @get_value_builtin (%Str %15)
  ret %Value* %16
}
...
;stmt4:
  ...
  %8 = load %Str, %Str* %id
  %9 = call  @get_value_from_block (%Block* %7, %Str %8)
...
;stmt11:
  ...
  %28 = load %Str, %Str* %id
  %29 = call  @get_value_from_params (%List* %27, %Str %28)
  ret %Value* %29
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt0:
  %1 = bitcast * @func202_str1 to %Str
  %2 = load %Str, %Str* %id
  %3 = call  @strcmp (%Str %1, %Str %2)
  %4 = icmp eq %Int32 %3, 0
  br i1 %4, label %then_0, label %else_0
then_0:
...
;stmt6:
  %12 = load %Str, %Str* %id
  %13 = bitcast * @func202_str2 to %Str
  %14 = call  @strcmp (%Str %12, %Str %13)
...
;stmt0:
  ...
  %2 = load %Str, %Str* %id
  %3 = bitcast %Str %2 to %Unit*
  %4 = call  @list_search (%List* %1, %ListSearchHandler @psearch, %Unit* %3)
...
;stmt4:
  ...
  %18 = call  @value_new (%ValueKind 1, %Type* %13, %Value* %15, %Value* %17)
...
;stmt0:
  ...
  %3 = add %Nat32 %2, 8
  %4 = add %Nat32 %3, 1
  %5 = call  @malloc (%Nat32 %4)
  %6 = bitcast %Unit* %5 to %Str

;stmt1:
  %7 = bitcast %Str %6 to %Unit*
  %8 = bitcast * @func206_str1 to %Str
  %9 = load %Str, %Str* %prefix
  %10 = load %Nat32, %Nat32* %uid
  %11 = call  @sprintf (%Unit* %7, %Str %8, %Str %9, %Nat32 %10)
...
;stmt4:
  ...
  %10 = getelementptr inbounds %Storage, %Storage* %9, i32 0, i32 3 ; eval_access
  %11 = load %Str, %Str* %10
  %12 = call  @strlen (%Str %11)
  %13 = add %Nat32 %12, 2
  %14 = call  @malloc (%Nat32 %13)
...
;stmt3:
  ...
  %9 = call  @get_suid (%Str %6, %Nat32 %8)
  store %Str %9, %Str* %id

;stmt4:
  %10 = call  @strlen (%Str %1)
  %11 = load %Str, %Str* %id
  %12 = call  @strlen (%Str %11)
  %13 = add %Nat32 %10, %12
  %14 = add %Nat32 %13, 1
  %15 = call  @malloc (%Nat32 %14)
  %16 = bitcast %Unit* %15 to %Str

;stmt5:
  %17 = bitcast %Str %16 to %Unit*
  %18 = bitcast * @func208_str1 to %Str
  %19 = load %Str, %Str* %id
  %20 = call  @sprintf (%Unit* %17, %Str %18, %Str %1, %Str %19)
...
;stmt0:
  %1 = bitcast * @func209_str1 to %Str
  %2 = getelementptr inbounds %Nat32, %Nat32* @func_uid, i32 0 ; ref
  %3 = call  @get_name (%Str %1, %Nat32* %2)
  ret %Str %3
}
...
;stmt3:
  %10 = bitcast * @func210_str2 to %Str
  %11 = getelementptr inbounds %Nat32, %Nat32* @str_uid, i32 0 ; ref
  %12 = call  @get_name (%Str %10, %Nat32* %11)
  ret %Str %12
}
...
;stmt3:
  %12 = load %Str, %Str* %id
  call  @bind_value_local (%Str %12, %Value* %6)

;stmt4:
  %13 = load %Str, %Str* %id
  %14 = load %Type*, %Type** %t
  %15 = load %Value*, %Value** %init_value
  %16 = call  @stmt_new_vardef (%Str %13, %Type* %14, %Value* %15)
  call  @add_stmt (%Stmt* %16)
...
;stmt7:
  ...
  %24 = call  @stmt_new_assign (%Value* %6, %Value* %21, %TokenInfo* %23)
  call  @add_stmt (%Stmt* %24)
  br label %endif_0
else_0:
  br label %endif_0
endif_0:
...
;stmt0:
  ...
  %5 = call  @asm_vardef_add (%Assembly* %1, %Str %2, %Type* %3, %Value* %4)
...
;stmt1:
  ...
  %9 = inttoptr %Nat32 0 to %Unit*
  %10 = bitcast %Unit* %9 to %Value*
  %11 = call  @value_new (%ValueKind 1, %Type* %6, %Value* %8, %Value* %10)
...
;stmt4:
  %17 = load %Str, %Str* %id
  call  @bind_value_global (%Str %17, %Value* %11)
  ret void
}
...
;stmt2:
  ...
  %11 = call  @list_append (%List* %8, %Unit* %10)
  br label %endif_0
else_0:
  br label %endif_0
endif_0:
...
;stmt8:
  %11 = call  @parse_type_record ()
  store %Type* %11, %Type** %t
  br label %endif_1
else_1:

;stmt9:
  %12 = bitcast * @func217_str2 to %Str
  %13 = call  @match (%Str %12)
  br i1 %13, label %then_2, label %else_2
then_2:
...
;stmt15:
  %16 = bitcast * @func217_str3 to %Str
  %17 = call  @match (%Str %16)
  br i1 %17, label %then_3, label %else_3
then_3:
...
;stmt21:
  %25 = call  @type_pointer_new (%Type* %18)
  store %Type* %25, %Type** %t
  br label %endif_3
else_3:

;stmt22:
  %26 = bitcast * @func217_str4 to %Str
  %27 = call  @match (%Str %26)
...
;stmt24:
  %28 = call  @parse_type_array ()
  store %Type* %28, %Type** %t
  br label %endif_5
else_5:

;stmt25:
  %29 = bitcast * @func217_str5 to %Str
  %30 = call  @match (%Str %29)
...
;stmt30:
  %36 = bitcast * @func217_str6 to %Str
  call  @error (%Str %36, %TokenInfo* %4)

;stmt31:
  %37 = bitcast * @func217_str7 to %Str
  %38 = call  @ctok ()
  %39 = getelementptr inbounds %Token, %Token* %38, i32 0, i32 2 ; eval_access
  %40 = load , * %39
  %41 = call  @printf (%Str %37,  %40)
  br label %endif_7
else_7:
...
;stmt33:
  ...
  %47 = bitcast * @func217_str8 to %Str
  %48 = call  @get (%Str %47)
  %49 = trunc %Nat64 %48 to %Nat8
  %50 = call  @alignment (%Nat32 %46, %Nat8 %49)
...
;stmt4:
  %7 = bitcast * @func218_str1 to %Str
  call  @error (%Str %7, %TokenInfo* %2)
...
;stmt10:
  %16 = call  @type_new_undefined (%Str %3)
  ret %Type* %16
}
...
;stmt9:
  %11 = bitcast * @func219_str1 to %Str
  call  @error (%Str %11, %TokenInfo* %6)
...
;stmt11:
  %13 = bitcast * @func219_str2 to %Str
  %14 = call  @match (%Str %13)

;stmt12:
  call  @skip_nl ()

;stmt13:
  %15 = call  @list_extend (%List* %1, %List* %7)
  br label %continue_0
break_0:
...
;stmt0:
  %1 = bitcast * @func220_str1 to %Str
  %2 = call  @need (%Str %1)

;stmt1:
  %3 = bitcast * @func220_str2 to %Str
  %4 = call  @parse_fields (%Str %3)

;stmt2:
  %5 = call  @type_record_new (%List* %4)
  ret %Type* %5
}
...
;stmt11:
  ...
  %14 = call  @list_append (%List* %1, %Unit* %13)
...
;stmt13:
  %17 = bitcast * @func221_str3 to %Str
  %18 = call  @match (%Str %17)
  %19 = xor %Bool %18, 1
...
;stmt16:
  %20 = bitcast * @func221_str4 to %Str
  %21 = call  @need (%Str %20)
...
;stmt6:
  %8 = call  @type_array_new (%Type* %3, %Nat32 0, %Bool 1)
  ret %Type* %8
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt11:
  %15 = bitcast * @func222_str2 to %Str
  %16 = call  @need (%Str %15)

;stmt12:
  %17 = call  @parse_type (%Bool 1)
...
;stmt16:
  ...
  %26 = call  @type_array_new (%Type* %17, %Nat32 %25, %Bool 0)
  ret %Type* %26
...
;stmt0:
  %1 = bitcast * @func223_str1 to %Str
  %2 = call  @parse_fields (%Str %1)

;stmt1:
  %3 = bitcast * @func223_str2 to %Str
  %4 = call  @need (%Str %3)

;stmt2:
  %5 = call  @parse_type (%Bool 1)
...
;stmt6:
  %16 = bitcast * @func223_str3 to %Str
  %17 = call  @get (%Str %16)
  %18 = icmp eq %Nat64 %17, 1

;stmt7:
  %19 = call  @type_func_new (%List* %2, %Type* %5, %Bool %18)
  ret %Type* %19
}
...
;stmt5:
  ...
  %12 = call  @un_ref (%Value* %10, %TokenInfo* %11)
  ret %Value* %12
  br label %endif_1
else_1:
...
;stmt8:
  ...
  %17 = load %TokenInfo*, %TokenInfo** %ti
  %18 = call  @un_deref (%Value* %16, %TokenInfo* %17)
  ret %Value* %18
  br label %endif_2
else_2:
...
;stmt11:
  ...
  %24 = call  @un_minus (%Value* %22, %TokenInfo* %23)
  ret %Value* %24
  br label %endif_3
else_3:
...
;stmt14:
  ...
  %30 = call  @un_not (%Value* %28, %TokenInfo* %29)
  ret %Value* %30
  br label %endif_4
else_4:
...
;stmt16:
  %32 = bitcast * @func224_str1 to %Str
  call  @assert (%Bool 0, %Str %32)
  br label %endif_4
endif_4:
  br label %endif_3
endif_3:
...
;stmt3:
  ...
  %14 = call  @value_new_imm_const (%Type* %8, %Int64 %13)
  ret %Value* %14
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt4:
  ...
  %21 = call  @value_new_register (%ValueKind 5, %Type* %17, %Value* %18, %Value* %20)
...
;stmt4:
  ...
  %19 = inttoptr %Nat32 0 to %Unit*
  %20 = bitcast %Unit* %19 to %Value*
  %21 = call  @value_new_register (%ValueKind 4, %Type* %17, %Value* %18, %Value* %20)
  store %Value* %21, %Value** %vx
...
;stmt0:
  ...
  %4 = inttoptr %Nat32 0 to %Unit*
  %5 = bitcast %Unit* %4 to %Value*
  %6 = call  @value_new_register (%ValueKind 2, %Type* %2, %Value* %3, %Value* %5)
...
;stmt0:
  ...
  %4 = inttoptr %Nat32 0 to %Unit*
  %5 = bitcast %Unit* %4 to %Value*
  %6 = call  @value_new_address (%ValueKind 3, %Type* %2, %Value* %3, %Value* %5)
...
;stmt6:
  %10 = call  @type_pointer_new (%Type* %5)
...
;stmt3:
  %7 = load %Type*, %Type** %t
  %8 = call  @type_is_basic_integer (%Type* %7)
  %9 = load %Type*, %Type** %t
...
;stmt6:
  ...
  %17 = call  @type_eq (%Type* %15, %Type* %16)
  br i1 %17, label %then_2, label %else_2
then_2:
...
;stmt7:
  ...
  %26 = call  @binImm (%ValueKind %23, %Value* %24, %Value* %25)
...
;stmt9:
  ...
  %31 = call  @value_new_register (%ValueKind %27, %Type* %28, %Value* %29, %Value* %30)
...
;stmt50:
  %59 = bitcast * @func234_str1 to %Str
  call  @assert (%Bool 0, %Str %59)
  br label %endif_13
endif_13:
  br label %endif_12
endif_12:
...
;stmt51:
  ...
  %62 = call  @value_new_imm_const (%Type* %60, %Int64 %61)
  ret %Value* %62
}
...
;stmt1:
  ...
  %7 = getelementptr inbounds , * %6, i32 0, %Int32 1 ; eval_index
  %8 = load %Value*, %Value** %7

;stmt2:
  %9 = call  @getType (%Value* %4)

;stmt3:
  %10 = call  @getType (%Value* %8)
...
;stmt11:
  %29 = call  @type_eq (%Type* %26, %Type* %28)
  %30 = xor %Bool %29, 1
...
;stmt13:
  %31 = bitcast * @func235_str1 to %Str
  %32 = load %Value*, %Value** %v
  %33 = getelementptr inbounds %Value, %Value* %32, i32 0, i32 8 ; eval_access
  %34 = load %TokenInfo*, %TokenInfo** %33
  call  @error (%Str %31, %TokenInfo* %34)

;stmt14:
  %35 = bitcast * @func235_str2 to %Str
  %36 = call  @printf (%Str %35)

;stmt15:
  call  @prttype (%Type* %26)

;stmt16:
  %37 = bitcast * @func235_str3 to %Str
  %38 = call  @printf (%Str %37)

;stmt17:
  %39 = bitcast * @func235_str4 to %Str
  %40 = call  @printf (%Str %39)

;stmt18:
  call  @prttype (%Type* %28)

;stmt19:
  %41 = bitcast * @func235_str5 to %Str
  %42 = call  @printf (%Str %41)
...
;stmt22:
  %47 = call  @binTypeOk (%ValueKind %46, %Type* %26)
  %48 = xor %Bool %47, 1
...
;stmt26:
  ...
  %58 = getelementptr inbounds , * %57, i32 0, %Int32 0 ; eval_index
  store %Value* %21, %Value** %58

;stmt27:
  %59 = load %Value*, %Value** %v
  %60 = getelementptr inbounds %Value, %Value* %59, i32 0, i32 3 ; eval_access
  %61 = getelementptr inbounds , * %60, i32 0, %Int32 1 ; eval_index
  store %Value* %24, %Value** %61

;stmt28:
  %62 = call  @isReletionOpKind (%ValueKind %46)
...
;stmt15:
  ...
  %49 = call  @value_new_imm_const (%Type* %47, %Int64 %48)
...
;stmt17:
  ...
  %54 = call  @value_new_register (%ValueKind %50, %Type* %51, %Value* %52, %Value* %53)
...
;stmt4:
  ...
  %12 = call  @castIfNumericTo (%Value* %4, %Type* %11)
  %13 = getelementptr inbounds %Value, %Value* %12, i32 0, i32 1 ; eval_access
  %14 = load %Type*, %Type** %13

;stmt5:
  %15 = load %Type*, %Type** @typeBaseInt
  %16 = call  @castIfNumericTo (%Value* %8, %Type* %15)
...
;stmt3:
  ...
  %15 = call  @value_new_address (%ValueKind 23, %Type* %12, %Value* %13, %Value* %14)
  ret %Value* %15
...
;stmt5:
  ...
  %14 = call  @castIfNumericTo (%Value* %8, %Type* %13)
...
;stmt4:
  ...
  %14 = inttoptr %Nat32 0 to %Unit*
  %15 = bitcast %Unit* %14 to %Value*
  %16 = call  @value_new_address (%ValueKind 24, %Type* %12, %Value* %13, %Value* %15)
...
;stmt12:
  ...
  %26 = load %Str, %Str* %25
  %27 = call  @type_record_get_field (%Type* %23, %Str %26)
...
;stmt15:
  %31 = bitcast * @func241_str2 to %Str
  %32 = load %Value*, %Value** %v
  %33 = getelementptr inbounds %Value, %Value* %32, i32 0, i32 8 ; eval_access
  %34 = load %TokenInfo*, %TokenInfo** %33
  call  @error (%Str %31, %TokenInfo* %34)
...
;stmt4:
  ...
  %16 = inttoptr %Nat32 0 to %Unit*
  %17 = bitcast %Unit* %16 to %Value*
  %18 = call  @value_new_register (%ValueKind 22, %Type* %14, %Value* %15, %Value* %17)
...
;stmt6:
  ...
  %22 = call  @checkParams (%Value* %4, %List* %18, %TokenInfo* %21)
...
;stmt3:
  %13 = bitcast * @func244_str1 to %Str
  %14 = load %TokenInfo*, %TokenInfo** %ti
  call  @error (%Str %13, %TokenInfo* %14)
...
;stmt9:
  %29 = bitcast * @func244_str2 to %Str
  %30 = load %TokenInfo*, %TokenInfo** %ti
  call  @error (%Str %29, %TokenInfo* %30)
  br label %endif_2
else_2:
  br label %endif_2
endif_2:
...
;stmt20:
  ...
  %56 = call  @type_eq (%Type* %53, %Type* %55)
  %57 = xor %Bool %56, 1
...
;stmt22:
  %58 = bitcast * @func244_str3 to %Str
  %59 = load %TokenInfo*, %TokenInfo** %ti
  call  @error (%Str %58, %TokenInfo* %59)

;stmt23:
  %60 = bitcast * @func244_str4 to %Str
  %61 = call  @printf (%Str %60)

;stmt24:
  %62 = getelementptr inbounds %Value, %Value* %51, i32 0, i32 1 ; eval_access
  %63 = load %Type*, %Type** %62
  call  @prttype (%Type* %63)

;stmt25:
  %64 = bitcast * @func244_str5 to %Str
  %65 = call  @printf (%Str %64)

;stmt26:
  %66 = bitcast * @func244_str6 to %Str
  %67 = call  @printf (%Str %66)

;stmt27:
  %68 = getelementptr inbounds %Field, %Field* %43, i32 0, i32 1 ; eval_access
  %69 = load %Type*, %Type** %68
  call  @prttype (%Type* %69)

;stmt28:
  %70 = bitcast * @func244_str7 to %Str
  %71 = call  @printf (%Str %70)
...
;stmt30:
  ...
  %76 = call  @list_subst (%List* %73, %Unit* %74, %Unit* %75)
...
;stmt37:
  %91 = call  @getType (%Value* %90)

;stmt38:
  %92 = load %Type*, %Type** @typeBaseInt
  %93 = call  @castIfNumericTo (%Value* %90, %Type* %92)

;stmt39:
  %94 = load %List*, %List** %a
  %95 = bitcast %Value* %90 to %Unit*
  %96 = bitcast %Value* %93 to %Unit*
  %97 = call  @list_subst (%List* %94, %Unit* %95, %Unit* %96)
...
;stmt3:
  %11 = load %Value*, %Value** %v
  %12 = load %Type*, %Type** %t
  %13 = call  @can_imm_cast (%Value* %11, %Type* %12)
  br i1 %13, label %then_1, label %else_1
then_1:
...
;stmt5:
  ...
  %19 = call  @value_new_imm_const (%Type* %14, %Int64 %18)
  ret %Value* %19
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt6:
  ...
  %26 = call  @value_new_register (%ValueKind 25, %Type* %22, %Value* %23, %Value* %25)
...
;stmt6:
  ...
  %10 = getelementptr inbounds , * %9, i32 0, %Int32 0 ; eval_index
...
;stmt10:
  ...
  %18 = call  @storage_is_const (%Storage* %17)
  %19 = xor %Bool %18, 1
...
;stmt6:
  %11 = bitcast * @func250_str1 to %Str
  %12 = call  @match (%Str %11)
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt11:
  %15 = call  @bin (%ValueKind 11, %Value* %13, %Value* %14, %TokenInfo* %10)
...
;stmt6:
  %11 = bitcast * @func251_str1 to %Str
  %12 = call  @match (%Str %11)
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt11:
  %15 = call  @bin (%ValueKind 12, %Value* %13, %Value* %14, %TokenInfo* %10)
  store %Value* %15, %Value** %v
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt6:
  %11 = bitcast * @func252_str1 to %Str
  %12 = call  @match (%Str %11)
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt11:
  %15 = call  @bin (%ValueKind 13, %Value* %13, %Value* %14, %TokenInfo* %10)
  store %Value* %15, %Value** %v
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt8:
  %11 = bitcast * @func253_str1 to %Str
  %12 = call  @match (%Str %11)
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt13:
  %15 = call  @bin (%ValueKind 14, %Value* %13, %Value* %14, %TokenInfo* %10)
  store %Value* %15, %Value** %v
  br label %endif_1
else_1:

;stmt14:
  %16 = bitcast * @func253_str2 to %Str
  %17 = call  @match (%Str %16)
  br i1 %17, label %then_2, label %else_2
then_2:
...
;stmt19:
  %20 = call  @bin (%ValueKind 15, %Value* %18, %Value* %19, %TokenInfo* %10)
...
;stmt8:
  %11 = bitcast * @func254_str1 to %Str
  %12 = call  @match (%Str %11)
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt13:
  %15 = call  @bin (%ValueKind 16, %Value* %13, %Value* %14, %TokenInfo* %10)
  store %Value* %15, %Value** %v
  br label %endif_1
else_1:

;stmt14:
  %16 = bitcast * @func254_str2 to %Str
  %17 = call  @match (%Str %16)
  br i1 %17, label %then_2, label %else_2
then_2:
...
;stmt19:
  %20 = call  @bin (%ValueKind 17, %Value* %18, %Value* %19, %TokenInfo* %10)
  store %Value* %20, %Value** %v
  br label %endif_2
else_2:

;stmt20:
  %21 = bitcast * @func254_str3 to %Str
  %22 = call  @match (%Str %21)
...
;stmt25:
  %25 = call  @bin (%ValueKind 18, %Value* %23, %Value* %24, %TokenInfo* %10)
  store %Value* %25, %Value** %v
  br label %endif_3
else_3:

;stmt26:
  %26 = bitcast * @func254_str4 to %Str
  %27 = call  @match (%Str %26)
  br i1 %27, label %then_4, label %else_4
then_4:
...
;stmt31:
  %30 = call  @bin (%ValueKind 19, %Value* %28, %Value* %29, %TokenInfo* %10)
...
;stmt8:
  %11 = bitcast * @func255_str1 to %Str
  %12 = call  @match (%Str %11)
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt13:
  %15 = call  @shift_op (%ValueKind 20, %Value* %13, %Value* %14, %TokenInfo* %10)
  store %Value* %15, %Value** %v
  br label %endif_1
else_1:

;stmt14:
  %16 = bitcast * @func255_str2 to %Str
  %17 = call  @match (%Str %16)
  br i1 %17, label %then_2, label %else_2
then_2:
...
;stmt19:
  %20 = call  @shift_op (%ValueKind 21, %Value* %18, %Value* %19, %TokenInfo* %10)
  store %Value* %20, %Value** %v
  br label %endif_2
else_2:
...
;stmt8:
  %11 = bitcast * @func256_str1 to %Str
  %12 = call  @match (%Str %11)
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt13:
  %15 = call  @bin (%ValueKind 6, %Value* %13, %Value* %14, %TokenInfo* %10)
  store %Value* %15, %Value** %v
  br label %endif_1
else_1:

;stmt14:
  %16 = bitcast * @func256_str2 to %Str
  %17 = call  @match (%Str %16)
  br i1 %17, label %then_2, label %else_2
then_2:
...
;stmt19:
  %20 = call  @bin (%ValueKind 7, %Value* %18, %Value* %19, %TokenInfo* %10)
  store %Value* %20, %Value** %v
  br label %endif_2
else_2:
...
;stmt8:
  %11 = bitcast * @func257_str1 to %Str
  %12 = call  @match (%Str %11)
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt13:
  %15 = call  @bin (%ValueKind 8, %Value* %13, %Value* %14, %TokenInfo* %10)
  store %Value* %15, %Value** %v
  br label %endif_1
else_1:

;stmt14:
  %16 = bitcast * @func257_str2 to %Str
  %17 = call  @match (%Str %16)
  br i1 %17, label %then_2, label %else_2
then_2:
...
;stmt19:
  %20 = call  @bin (%ValueKind 9, %Value* %18, %Value* %19, %TokenInfo* %10)
  store %Value* %20, %Value** %v
  br label %endif_2
else_2:

;stmt20:
  %21 = bitcast * @func257_str3 to %Str
  %22 = call  @match (%Str %21)
  br i1 %22, label %then_3, label %else_3
then_3:
...
;stmt25:
  %25 = call  @bin (%ValueKind 10, %Value* %23, %Value* %24, %TokenInfo* %10)
  store %Value* %25, %Value** %v
  br label %endif_3
else_3:
...
;stmt6:
  %11 = bitcast * @func258_str1 to %Str
  %12 = call  @match (%Str %11)
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt8:
  %13 = call  @parse_type (%Bool 0)

;stmt9:
  %14 = load %Value*, %Value** %v
  %15 = call  @cast (%Value* %14, %Type* %13, %TokenInfo* %10)
  store %Value* %15, %Value** %v
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt5:
  %6 = call  @un (%ValueKind 3, %Value* %5, %TokenInfo* %2)
  store %Value* %6, %Value** %v
  br label %endif_0
else_0:

;stmt6:
  %7 = bitcast * @func259_str2 to %Str
  %8 = call  @match (%Str %7)
  br i1 %8, label %then_1, label %else_1
then_1:
...
;stmt9:
  %10 = call  @un (%ValueKind 2, %Value* %9, %TokenInfo* %2)
  store %Value* %10, %Value** %v
  br label %endif_1
else_1:

;stmt10:
  %11 = bitcast * @func259_str3 to %Str
  %12 = call  @match (%Str %11)
...
;stmt13:
  %14 = call  @un (%ValueKind 4, %Value* %13, %TokenInfo* %2)
  store %Value* %14, %Value** %v
  br label %endif_2
else_2:

;stmt14:
  %15 = bitcast * @func259_str4 to %Str
  %16 = call  @match (%Str %15)
...
;stmt17:
  %18 = call  @un (%ValueKind 5, %Value* %17, %TokenInfo* %2)
  store %Value* %18, %Value** %v
  br label %endif_3
else_3:

;stmt18:
  %19 = bitcast * @func259_str5 to %Str
  %20 = call  @match (%Str %19)
...
;stmt24:
  %27 = bitcast * @func259_str6 to %Str
  call  @error (%Str %27, %TokenInfo* %22)
...
;stmt26:
  ...
  %35 = call  @value_new_imm_const (%Type* %31, %Int64 %34)
...
;stmt28:
  %38 = bitcast * @func259_str7 to %Str
  %39 = call  @match (%Str %38)
...
;stmt34:
  %46 = bitcast * @func259_str8 to %Str
  call  @error (%Str %46, %TokenInfo* %41)
...
;stmt36:
  ...
  %54 = call  @value_new_imm_const (%Type* %50, %Int64 %53)
...
;stmt8:
  %11 = bitcast * @func260_str1 to %Str
  %12 = call  @match (%Str %11)
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt11:
  br label %continue_1
continue_1:
  %14 = bitcast * @func260_str2 to %Str
  %15 = call  @match (%Str %14)
  %16 = xor %Bool %15, 1
...
;stmt16:
  %21 = bitcast * @func260_str3 to %Str
  call  @skipto (%Str %21)

;stmt17:
  %22 = bitcast * @func260_str4 to %Str
  %23 = call  @match (%Str %22)
  br i1 %23, label %then_3, label %else_3
then_3:
...
;stmt20:
  %25 = bitcast * @func260_str5 to %Str
  %26 = call  @match (%Str %25)
  br i1 %26, label %then_4, label %else_4
then_4:
...
;stmt25:
  ...
  %32 = call  @list_append (%List* %13, %Unit* %31)

;stmt26:
  %33 = bitcast * @func260_str6 to %Str
  %34 = call  @match (%Str %33)
  %35 = xor %Bool %34, 1
...
;stmt28:
  %36 = bitcast * @func260_str7 to %Str
  %37 = call  @need (%Str %36)
  br label %endif_5
else_5:
...
;stmt31:
  %39 = load %Value*, %Value** %v
  %40 = call  @call (%Value* %39, %List* %13, %TokenInfo* %10)
  store %Value* %40, %Value** %v
  br label %endif_1
else_1:

;stmt32:
  %41 = bitcast * @func260_str8 to %Str
  %42 = call  @match (%Str %41)
  br i1 %42, label %then_6, label %else_6
then_6:
...
;stmt35:
  %44 = bitcast * @func260_str9 to %Str
  %45 = call  @match (%Str %44)

;stmt36:
  %46 = load %Value*, %Value** %v
  %47 = call  @indx (%Value* %46, %Value* %43, %TokenInfo* %10)
  store %Value* %47, %Value** %v
  br label %endif_6
else_6:

;stmt37:
  %48 = bitcast * @func260_str10 to %Str
  %49 = call  @match (%Str %48)
...
;stmt40:
  %51 = load %Value*, %Value** %v
  %52 = call  @access (%Value* %51, %Str %50, %TokenInfo* %10)
...
;stmt9:
  %10 = bitcast * @func262_str2 to %Str
  %11 = call  @match (%Str %10)
  br i1 %11, label %then_2, label %else_2
then_2:
...
;stmt5:
  ...
  %10 = call  @type_array_new (%Type* %9, %Nat32 %7, %Bool 0)

;stmt6:
  %11 = call  @get_name_str ()
...
;stmt7:
  ...
  %14 = inttoptr %Nat32 0 to %Unit*
  %15 = bitcast %Unit* %14 to %Value*
  %16 = call  @value_new (%ValueKind 1, %Type* %10, %Value* %13, %Value* %15)
...
;stmt12:
  ...
  %28 = call  @asm_constdef_add (%Assembly* %27, %Str %11, %Value* %16)

;stmt13:
  %29 = call  @type_pointer_new (%Type* %10)
  %30 = inttoptr %Nat32 0 to %Unit*
  %31 = bitcast %Unit* %30 to %Value*
  %32 = inttoptr %Nat32 0 to %Unit*
  %33 = bitcast %Unit* %32 to %Value*
  %34 = call  @value_new (%ValueKind 1, %Type* %29, %Value* %31, %Value* %33)
...
;stmt18:
  ...
  %47 = bitcast %Unit* %46 to %Value*
  %48 = call  @value_new (%ValueKind 25, %Type* %45, %Value* %34, %Value* %47)
...
;stmt1:
  %3 = call  @parse_type (%Bool 0)

;stmt2:
  %4 = bitcast * @func264_str1 to %Str
  %5 = call  @need (%Str %4)
...
;stmt12:
  %15 = bitcast * @func264_str3 to %Str
  %16 = call  @match (%Str %15)
...
;stmt15:
  ...
  %22 = call  @list_append (%List* %6, %Unit* %21)

;stmt16:
  %23 = bitcast * @func264_str4 to %Str
  %24 = call  @match (%Str %23)
  br label %continue_0
break_0:

;stmt17:
  %25 = call  @get_name_arr ()

;stmt18:
  %26 = load %Nat32, %Nat32* %len
  %27 = call  @type_array_new (%Type* %3, %Nat32 %26, %Bool 0)
...
;stmt19:
  ...
  %30 = inttoptr %Nat32 0 to %Unit*
  %31 = bitcast %Unit* %30 to %Value*
  %32 = call  @value_new (%ValueKind 1, %Type* %27, %Value* %29, %Value* %31)
...
;stmt24:
  %40 = getelementptr inbounds %Assembly, %Assembly* @asm0, i32 0 ; ref
  %41 = call  @asm_constdef_add (%Assembly* %40, %Str %25, %Value* %32)
...
;stmt13:
  %21 = bitcast * @func265_str1 to %Str
  %22 = call  @printf (%Str %21)
...
;stmt18:
  %28 = bitcast * @func265_str2 to %Str
  %29 = call  @printf (%Str %28)
...
;stmt24:
  ...
  %42 = call  @value_new (%ValueKind 1, %Type* %24, %Value* %39, %Value* %41)
...
;stmt27:
  ...
  %49 = call  @list_append (%List* %47, %Unit* %48)
  br label %endif_3
else_3:
  br label %endif_3
endif_3:
...
;stmt33:
  %57 = bitcast * @func265_str4 to %Str
  %58 = call  @need (%Str %57)
...
;stmt36:
  ...
  %62 = call  @asm_funcdef_add (%Assembly* %61, %Str %17, %Type* %24, %Block* %59)
...
;stmt9:
  ...
  %19 = inttoptr %Nat32 0 to %Unit*
  %20 = bitcast %Unit* %19 to %Value*
  %21 = call  @value_new (%ValueKind 1, %Type* %16, %Value* %18, %Value* %20)
...
;stmt12:
  %27 = load %Value*, %Value** %v
  call  @bind_value_global (%Str %3, %Value* %27)
  br label %endif_1
else_1:
  br label %endif_1
endif_1:
...
;stmt3:
  %4 = getelementptr inbounds %Token, %Token* %3, i32 0, i32 2 ; eval_access
  %5 = getelementptr inbounds , * %4, i32 0, %Int32 0 ; eval_index
  %6 = load %Nat8, %Nat8* %5
  %7 = bitcast * @func267_str1 to %Str
  %8 = getelementptr inbounds %Nat8, %Str %7, %Int32 0 ; eval_index
  %9 = load %Nat8, %Nat8* %8
  %10 = icmp eq %Nat8 %6, %9
  %11 = getelementptr inbounds %Token, %Token* %3, i32 0, i32 2 ; eval_access
  %12 = getelementptr inbounds , * %11, i32 0, %Int32 1 ; eval_index
  %13 = load %Nat8, %Nat8* %12
  %14 = bitcast * @func267_str2 to %Str
  %15 = getelementptr inbounds %Nat8, %Str %14, %Int32 0 ; eval_index
  %16 = load %Nat8, %Nat8* %15
  %17 = icmp eq %Nat8 %13, %16
  %18 = and %Bool %10, %17
...
;stmt5:
  ...
  %20 = getelementptr inbounds , * %19, i32 0, %Int32 2 ; eval_index
  %21 = bitcast %Nat8* %20 to %Unit*
  %22 = bitcast * @func267_str3 to %Str
  %23 = getelementptr inbounds %Int64, %Int64* %d, i32 0 ; ref
  %24 = call  @sscanf (%Unit* %21, %Str %22, %Int64* %23)
  br label %endif_0
else_0:
...
;stmt7:
  ...
  %28 = bitcast * @func267_str4 to %Str
  %29 = getelementptr inbounds %Int64, %Int64* %d, i32 0 ; ref
  %30 = call  @sscanf (%Unit* %27, %Str %28, %Int64* %29)
  br label %endif_0
endif_0:
...
;stmt11:
  ...
  %34 = call  @value_new_imm_const (%Type* %31, %Int64 %33)
...
;stmt3:
  ...
  %16 = call  @stmt_new_assign (%Value* %13, %Value* %14, %TokenInfo* %15)
  ret %Stmt* %16
}
...
;stmt4:
  ...
  %12 = call  @storageIsMutable (%Storage* %11)
  %13 = xor %Bool %12, 1
  br i1 %13, label %then_0, label %else_0
then_0:
...
;stmt11:
  %25 = bitcast * @func270_str2 to %Str
  %26 = load %Stmt*, %Stmt** %s
  %27 = getelementptr inbounds %Stmt, %Stmt* %26, i32 0, i32 7 ; eval_access
  %28 = load %TokenInfo*, %TokenInfo** %27
  call  @error (%Str %25, %TokenInfo* %28)

;stmt12:
  %29 = bitcast * @func270_str3 to %Str
  %30 = call  @printf (%Str %29)

;stmt13:
  call  @prttype (%Type* %9)

;stmt14:
  %31 = bitcast * @func270_str4 to %Str
  %32 = call  @printf (%Str %31)

;stmt15:
  %33 = bitcast * @func270_str5 to %Str
  %34 = call  @printf (%Str %33)

;stmt16:
  %35 = getelementptr inbounds %Value, %Value* %20, i32 0, i32 1 ; eval_access
  %36 = load %Type*, %Type** %35
  call  @prttype (%Type* %36)

;stmt17:
  %37 = bitcast * @func270_str6 to %Str
  %38 = call  @printf (%Str %37)
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt18:
  ...
  %41 = getelementptr inbounds , * %40, i32 0, %Int32 1 ; eval_index
...
;stmt4:
  ...
  %11 = call  @type_eq (%Type* %6, %Type* %10)
  %12 = xor %Bool %11, 1
  br i1 %12, label %then_1, label %else_1
then_1:
...
;stmt6:
  %13 = bitcast * @func272_str1 to %Str
  %14 = getelementptr inbounds %Type, %Type* %6, i32 0, i32 13 ; eval_access
  %15 = load %TokenInfo*, %TokenInfo** %14
  call  @error (%Str %13, %TokenInfo* %15)
  br label %endif_1
...
;stmt9:
  ...
  %14 = getelementptr inbounds , * %13, i32 0, %Int32 0 ; eval_index
  %15 = load %Value*, %Value** %14
  %16 = call  @getType (%Value* %15)
  br label %endif_2
else_2:
...
;stmt2:
  ...
  %7 = load %List*, %List** %6
  %8 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %7, %ListForeachHandler @chkf, %Unit* %8)
...
;stmt3:
  ...
  %12 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %11, %ListForeachHandler @chkb, %Unit* %12)
...
;stmt7:
  %10 = call  @stmtBlock (%TokenInfo* %2)
  ret %Stmt* %10
  br label %endif_1
else_1:

;stmt8:
  %12 = bitcast * @func280_str3 to %Str
  %13 = call  @match (%Str %12)
  br i1 %13, label %then_2, label %else_2
then_2:
...
;stmt10:
  %14 = call  @stmtIf (%TokenInfo* %2)
  ret %Stmt* %14
  br label %endif_2
else_2:

;stmt11:
  %16 = bitcast * @func280_str4 to %Str
  %17 = call  @match (%Str %16)
  br i1 %17, label %then_3, label %else_3
then_3:
...
;stmt13:
  %18 = call  @stmtWhile (%TokenInfo* %2)
  ret %Stmt* %18
  br label %endif_3
else_3:

;stmt14:
  %20 = bitcast * @func280_str5 to %Str
  %21 = call  @match (%Str %20)
  br i1 %21, label %then_4, label %else_4
then_4:
...
;stmt16:
  %22 = call  @stmtRet (%TokenInfo* %2)
  ret %Stmt* %22
  br label %endif_4
else_4:

;stmt17:
  %24 = bitcast * @func280_str6 to %Str
  %25 = call  @match (%Str %24)
...
;stmt19:
  %26 = call  @stmtBreak (%TokenInfo* %2)
  ret %Stmt* %26
  br label %endif_5
else_5:

;stmt20:
  %28 = bitcast * @func280_str7 to %Str
  %29 = call  @match (%Str %28)
  br i1 %29, label %then_6, label %else_6
then_6:
...
;stmt22:
  %30 = call  @stmtContinue (%TokenInfo* %2)
  ret %Stmt* %30
  br label %endif_6
else_6:

;stmt23:
  %32 = bitcast * @func280_str8 to %Str
  %33 = call  @match (%Str %32)
...
;stmt28:
  %38 = bitcast * @func280_str9 to %Str
  %39 = call  @match (%Str %38)
...
;stmt33:
  %44 = bitcast * @func280_str10 to %Str
  %45 = call  @match (%Str %44)
...
;stmt41:
  %56 = bitcast * @func280_str11 to %Str
  %57 = call  @match (%Str %56)
...
;stmt43:
  call  @setlab (%Str %53, %TokenInfo* %55)
...
;stmt4:
  %9 = bitcast * @func282_str2 to %Str
  %10 = call  @need (%Str %9)

;stmt5:
  %11 = getelementptr inbounds %If, %If* %2, i32 0, i32 1 ; eval_access
  %12 = call  @stmtBlock (%TokenInfo* %8)
  store %Stmt* %12, %Stmt** %11

;stmt6:
  %13 = bitcast * @func282_str3 to %Str
  %14 = call  @match (%Str %13)
  br i1 %14, label %then_0, label %else_0
then_0:
...
;stmt8:
  %15 = bitcast * @func282_str4 to %Str
  %16 = call  @match (%Str %15)
...
;stmt10:
  %19 = bitcast * @func282_str5 to %Str
  %20 = call  @match (%Str %19)
  br i1 %20, label %then_1, label %else_1
then_1:
...
;stmt14:
  %23 = bitcast * @func282_str6 to %Str
  %24 = call  @need (%Str %23)

;stmt15:
  %25 = getelementptr inbounds %If, %If* %2, i32 0, i32 2 ; eval_access
  %26 = call  @stmtBlock (%TokenInfo* %18)
...
;stmt9:
  %11 = bitcast * @func284_str1 to %Str
  call  @error (%Str %11, %TokenInfo* %5)
  br label %endif_1
else_1:
  br label %endif_1
endif_1:
...
;stmt12:
  %19 = call  @assign (%Value* %1, %Value* %18, %TokenInfo* %7)
  ret %Stmt* %19
...
;stmt14:
  %21 = bitcast * @func289_str2 to %Str
  %22 = call  @printf (%Str %21)

;stmt15:
  %23 = bitcast * @func289_str3 to %Str
  %24 = call  @ctok ()
  %25 = getelementptr inbounds %Token, %Token* %24, i32 0, i32 2 ; eval_access
  %26 = getelementptr inbounds , * %25, i32 0, %Int32 0 ; eval_index
  %27 = call  @printf (%Str %23, %Nat8* %26)
...
;stmt0:
  ...
  %2 = bitcast * @func292_str1 to %Str
  %3 = load %Str, %Str* %s
  %4 = call  @fprintf (%Unit* %1, %Str %2, %Str %3)
  ret void
}
...
;stmt2:
  ...
  %3 = bitcast * @func297_str1 to %Str
  %4 = call  @fprintf (%Unit* %2, %Str %3)
  br label %endif_0
else_0:
  br label %endif_0
endif_0:
...
;stmt3:
  ...
  %8 = load %Type*, %Type** %7
  call  @print_type (%Type* %8, %Bool 1, %Bool 1)
...
;stmt3:
  ...
  %15 = bitcast * @func296_str2 to %Str
  %16 = load %Type*, %Type** %t
  %17 = getelementptr inbounds %Type, %Type* %16, i32 0, i32 1 ; eval_access
  %18 = load %Str, %Str* %17
  %19 = call  @fprintf (%Unit* %14, %Str %15, %Str %18)
...
;stmt8:
  ...
  %26 = bitcast * @func296_str3 to %Str
  %27 = load %Type*, %Type** %t
  ...
  %30 = load %Str, %Str* %29
  %31 = call  @fprintf (%Unit* %25, %Str %26, %Str %30)
  br label %endif_1
else_1:
...
;stmt11:
  ...
  call  @print_type (%Type* %33, %Bool 1, %Bool 1)
  br label %endif_2
else_2:
...
;stmt14:
  ...
  %36 = bitcast * @func296_str4 to %Str
  %37 = call  @fprintf (%Unit* %35, %Str %36)
...
;stmt16:
  ...
  %42 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %41, %ListForeachHandler @print_struct_field, %Unit* %42)

;stmt17:
  %43 = load %Unit*, %Unit** @fout
  %44 = bitcast * @func296_str5 to %Str
  %45 = call  @fprintf (%Unit* %43, %Str %44)
  br label %endif_3
else_3:
...
;stmt22:
  ...
  call  @print_type (%Type* %54, %Bool 1, %Bool 1)

;stmt23:
  %55 = bitcast * @func296_str6 to %Str
  call  @o (%Str %55)
  br label %endif_5
else_5:
...
;stmt25:
  ...
  %57 = bitcast * @func296_str7 to %Str
  %58 = load %Type*, %Type** %t
  ...
  %62 = call  @fprintf (%Unit* %56, %Str %57, %Nat32 %61)
...
;stmt26:
  ...
  call  @print_type (%Type* %66, %Bool 1, %Bool 1)

;stmt27:
  %67 = load %Unit*, %Unit** @fout
  %68 = bitcast * @func296_str8 to %Str
  %69 = call  @fprintf (%Unit* %67, %Str %68)
  br label %endif_5
endif_5:
  br label %endif_4
else_4:
...
;stmt30:
  ...
  call  @print_type (%Type* %74, %Bool 1, %Bool 1)

;stmt31:
  %75 = load %Unit*, %Unit** @fout
  %76 = bitcast * @func296_str9 to %Str
  %77 = call  @fprintf (%Unit* %75, %Str %76)
  br label %endif_6
else_6:
...
;stmt34:
  ...
  %84 = call  @type_eq (%Type* %82, %Type* %83)
...
;stmt36:
  ...
  %86 = bitcast * @func296_str10 to %Str
  %87 = call  @fprintf (%Unit* %85, %Str %86)
  br label %endif_8
else_8:
...
;stmt38:
  ...
  call  @print_type (%Type* %91, %Bool 1, %Bool 1)
  br label %endif_8
endif_8:

;stmt39:
  %92 = load %Unit*, %Unit** @fout
  %93 = bitcast * @func296_str11 to %Str
  %94 = call  @fprintf (%Unit* %92, %Str %93)
...
;stmt41:
  ...
  call  @list_foreach (%List* %98, %ListForeachHandler @pt_print_param, %Unit* %99)
...
;stmt44:
  %104 = bitcast * @func296_str12 to %Str
  call  @o (%Str %104)
  br label %endif_9
else_9:
  br label %endif_9
...
;stmt45:
  ...
  %106 = bitcast * @func296_str13 to %Str
  %107 = call  @fprintf (%Unit* %105, %Str %106)
...
;stmt48:
  ...
  %110 = bitcast * @func296_str14 to %Str
  %111 = call  @fprintf (%Unit* %109, %Str %110)
  br label %endif_10
else_10:
  br label %endif_10
endif_10:
...
;stmt51:
  ...
  %114 = bitcast * @func296_str15 to %Str
  ...
  %119 = call  @fprintf (%Unit* %113, %Str %114, %Str %118)
  br label %endif_11
else_11:
  br label %endif_11
endif_11:
...
;stmt0:
  %1 = load %Unit*, %Unit** @fout
  %2 = bitcast * @func300_str1 to %Str
  %3 = load %Nat32, %Nat32* @stmtno
  %4 = call  @fprintf (%Unit* %1, %Str %2, %Nat32 %3)
...
;stmt8:
  ...
  %17 = getelementptr inbounds , * %16, i32 0, %Int32 0 ; eval_index
  %18 = load %Value*, %Value** %17
  %19 = load %Stmt*, %Stmt** %s
  %20 = getelementptr inbounds %Stmt, %Stmt* %19, i32 0, i32 1 ; eval_access
  %21 = getelementptr inbounds , * %20, i32 0, %Int32 1 ; eval_index
  %22 = load %Value*, %Value** %21
  call  @print_stmt_let (%Value* %18, %Value* %22)
  br label %endif_1
else_1:
...
;stmt17:
  ...
  %35 = getelementptr inbounds , * %34, i32 0, %Int32 0 ; eval_index
  %36 = load %Value*, %Value** %35
  %37 = load %Stmt*, %Stmt** %s
  %38 = getelementptr inbounds %Stmt, %Stmt* %37, i32 0, i32 1 ; eval_access
  %39 = getelementptr inbounds , * %38, i32 0, %Int32 1 ; eval_index
  %40 = load %Value*, %Value** %39
  call  @print_st (%Value* %36, %Value* %40)
  br label %endif_4
else_4:
...
;stmt23:
  ...
  call  @print_stmt_while (%While* %48)
  br label %endif_6
else_6:
...
;stmt26:
  ...
  %52 = getelementptr inbounds , * %51, i32 0, %Int32 0 ; eval_index
  %53 = load %Value*, %Value** %52
  call  @print_stmt_return (%Value* %53)
  br label %endif_7
else_7:
...
;stmt40:
  ...
  %65 = bitcast * @func300_str2 to %Str
  %66 = call  @fprintf (%Unit* %64, %Str %65)
...
;stmt3:
  ...
  %10 = bitcast * @func304_str1 to %Str
  %11 = call  @fprintf (%Unit* %9, %Str %10)

;stmt4:
  call  @print_value (%Value* %8)

;stmt5:
  %12 = load %Unit*, %Unit** @fout
  %13 = bitcast * @func304_str2 to %Str
  %14 = call  @fprintf (%Unit* %12, %Str %13, %Nat32 %1, %Nat32 %1)

;stmt6:
  %15 = load %Unit*, %Unit** @fout
  %16 = bitcast * @func304_str3 to %Str
  %17 = call  @fprintf (%Unit* %15, %Str %16, %Nat32 %1)

;stmt7:
  %18 = load %If*, %If** %i
  %19 = getelementptr inbounds %If, %If* %18, i32 0, i32 1 ; eval_access
  %20 = load %Stmt*, %Stmt** %19
  call  @print_stmt (%Stmt* %20)

;stmt8:
  %21 = load %Unit*, %Unit** @fout
  %22 = bitcast * @func304_str4 to %Str
  %23 = call  @fprintf (%Unit* %21, %Str %22, %Nat32 %1)

;stmt9:
  %24 = load %Unit*, %Unit** @fout
  %25 = bitcast * @func304_str5 to %Str
  %26 = call  @fprintf (%Unit* %24, %Str %25, %Nat32 %1)
...
;stmt13:
  ...
  %37 = bitcast * @func304_str6 to %Str
  %38 = call  @fprintf (%Unit* %36, %Str %37, %Nat32 %1)

;stmt14:
  %39 = load %Unit*, %Unit** @fout
  %40 = bitcast * @func304_str7 to %Str
  %41 = call  @fprintf (%Unit* %39, %Str %40, %Nat32 %1)
  ret void
}
...
;stmt3:
  ...
  %6 = bitcast * @func305_str1 to %Str
  %7 = load %Nat32, %Nat32* @while_id
  %8 = call  @fprintf (%Unit* %5, %Str %6, %Nat32 %7)

;stmt4:
  %9 = load %Unit*, %Unit** @fout
  %10 = bitcast * @func305_str2 to %Str
  %11 = load %Nat32, %Nat32* @while_id
  %12 = call  @fprintf (%Unit* %9, %Str %10, %Nat32 %11)

;stmt5:
  %13 = load %While*, %While** %w
  %14 = getelementptr inbounds %While, %While* %13, i32 0, i32 0 ; eval_access
  %15 = load %Value*, %Value** %14
  %16 = call  @eval (%Value* %15)
  %17 = call  @load (%Value* %16)

;stmt6:
  %18 = load %Unit*, %Unit** @fout
  %19 = bitcast * @func305_str3 to %Str
  %20 = call  @fprintf (%Unit* %18, %Str %19)

;stmt7:
  call  @print_value (%Value* %17)

;stmt8:
  %21 = load %Unit*, %Unit** @fout
  %22 = bitcast * @func305_str4 to %Str
  %23 = load %Nat32, %Nat32* @while_id
  %24 = load %Nat32, %Nat32* @while_id
  %25 = call  @fprintf (%Unit* %21, %Str %22, %Nat32 %23, %Nat32 %24)

;stmt9:
  %26 = load %Unit*, %Unit** @fout
  %27 = bitcast * @func305_str5 to %Str
  %28 = load %Nat32, %Nat32* @while_id
  %29 = call  @fprintf (%Unit* %26, %Str %27, %Nat32 %28)

;stmt10:
  %30 = load %While*, %While** %w
  %31 = getelementptr inbounds %While, %While* %30, i32 0, i32 1 ; eval_access
  %32 = load %Stmt*, %Stmt** %31
  call  @print_stmt (%Stmt* %32)

;stmt11:
  %33 = load %Unit*, %Unit** @fout
  %34 = bitcast * @func305_str6 to %Str
  %35 = load %Nat32, %Nat32* @while_id
  %36 = call  @fprintf (%Unit* %33, %Str %34, %Nat32 %35)

;stmt12:
  %37 = load %Unit*, %Unit** @fout
  %38 = bitcast * @func305_str7 to %Str
  %39 = load %Nat32, %Nat32* @while_id
  %40 = call  @fprintf (%Unit* %37, %Str %38, %Nat32 %39)
...
;stmt5:
  ...
  %9 = call  @eval (%Value* %8)
  %10 = call  @load (%Value* %9)

;stmt6:
  %11 = load %Unit*, %Unit** @fout
  %12 = bitcast * @func306_str2 to %Str
  %13 = call  @fprintf (%Unit* %11, %Str %12)

;stmt7:
  %14 = getelementptr inbounds %Value, %Value* %10, i32 0, i32 1 ; eval_access
  %15 = load %Type*, %Type** %14
  call  @print_type (%Type* %15, %Bool 1, %Bool 1)

;stmt8:
  call  @space ()

;stmt9:
  call  @print_value (%Value* %10)
...
;stmt1:
  %2 = load %Unit*, %Unit** @fout
  %3 = bitcast * @func307_str1 to %Str
  %4 = load %Nat32, %Nat32* @while_id
  %5 = call  @fprintf (%Unit* %2, %Str %3, %Nat32 %4)
  ret void
}
...
;stmt1:
  %2 = load %Unit*, %Unit** @fout
  %3 = bitcast * @func309_str1 to %Str
  %4 = load %Str, %Str* %l
  %5 = call  @fprintf (%Unit* %2, %Str %3, %Str %4)
  ret void
}
...
;stmt0:
  %1 = load %Unit*, %Unit** @fout
  %2 = bitcast * @func310_str1 to %Str
  %3 = load %Str, %Str* %l
  %4 = call  @fprintf (%Unit* %1, %Str %2, %Str %3)

;stmt1:
  %5 = load %Unit*, %Unit** @fout
  %6 = bitcast * @func310_str2 to %Str
  %7 = load %Str, %Str* %l
  %8 = call  @fprintf (%Unit* %5, %Str %6, %Str %7)
  ret void
}
...
;stmt0:
  ...
  %3 = load %List*, %List** %2
  %4 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %3, %ListForeachHandler @for_stmt, %Unit* %4)
  ret void
}
...
;stmt0:
  %1 = load %Unit*, %Unit** @fout
  %2 = bitcast * @func313_str1 to %Str
  %3 = call  @fprintf (%Unit* %1, %Str %2)
...
;stmt3:
  ...
  %11 = getelementptr inbounds %Value, %Value* %10, i32 0, i32 1 ; eval_access
  %12 = load %Type*, %Type** %11
  call  @print_type (%Type* %12, %Bool 1, %Bool 1)
...
;stmt5:
  %13 = load %Value*, %Value** %v
  call  @print_value (%Value* %13)

;stmt6:
  %14 = load %Unit*, %Unit** @fout
  %15 = bitcast * @func313_str2 to %Str
  %16 = load %Nat32, %Nat32* %ino
  %17 = call  @fprintf (%Unit* %14, %Str %15, %Nat32 %16)
  ret void
}
...
;stmt3:
  ...
  %7 = bitcast * @func314_str1 to %Str
  %8 = load %Value*, %Value** %v
  %9 = getelementptr inbounds %Value, %Value* %8, i32 0, i32 2 ; eval_access
  %10 = getelementptr inbounds %Storage, %Storage* %9, i32 0, i32 1 ; eval_access
  %11 = load %Int64, %Int64* %10
  %12 = call  @fprintf (%Unit* %6, %Str %7, %Int64 %11)
  br label %endif_0
else_0:
...
;stmt9:
  %24 = load %Unit*, %Unit** @fout
  %25 = bitcast * @func314_str3 to %Str
  ...
  %29 = load %Str, %Str* %28
  %30 = call  @fprintf (%Unit* %24, %Str %25, %Str %29)
  br label %endif_2
else_2:
...
;stmt12:
  ...
  %33 = bitcast * @func314_str4 to %Str
  %34 = load %Value*, %Value** %v
  %35 = getelementptr inbounds %Value, %Value* %34, i32 0, i32 2 ; eval_access
  %36 = getelementptr inbounds %Storage, %Storage* %35, i32 0, i32 3 ; eval_access
  %37 = load %Str, %Str* %36
  %38 = call  @fprintf (%Unit* %32, %Str %33, %Str %37)
  br label %endif_3
else_3:
...
;stmt15:
  ...
  %45 = bitcast * @func314_str5 to %Str
  %46 = load %Value*, %Value** %v
  ...
  %49 = load %Str, %Str* %48
  %50 = call  @fprintf (%Unit* %44, %Str %45, %Str %49)
  br label %endif_4
else_4:
...
;stmt18:
  ...
  %53 = bitcast * @func314_str6 to %Str
  %54 = call  @fprintf (%Unit* %52, %Str %53)
  br label %endif_5
else_5:
  br label %endif_5
endif_5:
...
;stmt4:
  ...
  %9 = bitcast * @func316_str1 to %Str
  %10 = call  @fprintf (%Unit* %8, %Str %9, %Nat32 %7)

;stmt5:
  %11 = load %Value*, %Value** %v
  %12 = getelementptr inbounds %Value, %Value* %11, i32 0, i32 1 ; eval_access
  %13 = load %Type*, %Type** %12
  call  @print_type (%Type* %13, %Bool 1, %Bool 1)
...
;stmt7:
  ...
  %16 = load %Type*, %Type** %15
  call  @print_type (%Type* %16, %Bool 1, %Bool 1)

;stmt8:
  %17 = bitcast * @func316_str2 to %Str
  call  @o (%Str %17)

;stmt9:
  %18 = load %Value*, %Value** %v
  call  @print_value (%Value* %18)

;stmt10:
  %19 = load %Value*, %Value** %v
  %20 = getelementptr inbounds %Value, %Value* %19, i32 0, i32 1 ; eval_access
  %21 = load %Type*, %Type** %20
  %22 = call  @nv (%Type* %21, %StorageClass 9, %Nat32 %7)
  ret %Value* %22
}
...
;stmt2:
  ...
  %6 = call  @load (%Value* %5)
  %7 = bitcast %Value* %6 to %Unit*
  %8 = call  @list_append (%List* %4, %Unit* %7)
  ret void
}
...
;stmt10:
  ...
  %20 = load %Type*, %Type** %19
  call  @print_type (%Type* %20, %Bool 1, %Bool 1)
  br label %endif_1
endif_1:
...
;stmt3:
  ...
  call  @list_foreach (%List* %10, %ListForeachHandler @eval_args, %Unit* %11)
...
;stmt5:
  ...
  %18 = call  @type_eq (%Type* %16, %Type* %17)
  br i1 %18, label %then_0, label %else_0
then_0:
...
;stmt7:
  ...
  %20 = bitcast * @func317_str1 to %Str
  %21 = call  @fprintf (%Unit* %19, %Str %20)
  br label %endif_0
else_0:
...
;stmt10:
  ...
  %24 = bitcast * @func317_str2 to %Str
  %25 = load %Nat32, %Nat32* %retval_reg
  %26 = call  @fprintf (%Unit* %23, %Str %24, %Nat32 %25)
  br label %endif_0
endif_0:
...
;stmt11:
  ...
  %28 = load %Type*, %Type** %27
  call  @print_type (%Type* %28, %Bool 0, %Bool 0)

;stmt12:
  call  @space ()

;stmt13:
  call  @print_value (%Value* %6)

;stmt14:
  %29 = bitcast * @func317_str3 to %Str
  call  @o (%Str %29)
...
;stmt18:
  ...
  call  @list_foreach (%List* %7, %ListForeachHandler @print_args, %Unit* %38)

;stmt19:
  %39 = bitcast * @func317_str4 to %Str
  call  @o (%Str %39)
...
;stmt20:
  ...
  %44 = call  @nv (%Type* %42, %StorageClass 9, %Nat32 %43)
  ret %Value* %44
}
...
;stmt2:
  ...
  %8 = getelementptr inbounds , * %7, i32 0, %Int32 1 ; eval_index
  %9 = load %Value*, %Value** %8
  %10 = call  @eval (%Value* %9)
  %11 = call  @load (%Value* %10)
...
;stmt7:
  %21 = load %Unit*, %Unit** @fout
  %22 = bitcast * @func320_str1 to %Str
  %23 = call  @fprintf (%Unit* %21, %Str %22, %Nat32 %20)
...
;stmt10:
  ...
  call  @print_type (%Type* %32, %Bool 1, %Bool 1)
  br label %endif_1
else_1:
...
;stmt12:
  ...
  call  @print_type (%Type* %35, %Bool 1, %Bool 1)
  br label %endif_1
endif_1:
...
;stmt14:
  ...
  call  @print_type (%Type* %38, %Bool 1, %Bool 1)
...
;stmt19:
  %45 = bitcast * @func320_str2 to %Str
  call  @o (%Str %45)
  br label %endif_2
endif_2:
...
;stmt23:
  %54 = bitcast * @func320_str3 to %Str
  call  @o (%Str %54)
  br label %endif_3
else_3:
  br label %endif_3
...
;stmt25:
  ...
  call  @print_type (%Type* %56, %Bool 1, %Bool 1)

;stmt26:
  call  @space ()

;stmt27:
  call  @print_value (%Value* %11)

;stmt28:
  %57 = bitcast * @func320_str4 to %Str
  call  @o (%Str %57)
...
;stmt29:
  ...
  %61 = call  @nv (%Type* %60, %StorageClass 8, %Nat32 %20)
  ret %Value* %61
}
...
;stmt9:
  ...
  %29 = bitcast * @func321_str1 to %Str
  call  @assert (%Bool %28, %Str %29)
...
;stmt10:
  ...
  %33 = load %Str, %Str* %32
  %34 = call  @type_record_get_field (%Type* %30, %Str %33)
...
;stmt12:
  ...
  %39 = bitcast * @func321_str2 to %Str
  %40 = call  @fprintf (%Unit* %38, %Str %39, %Nat32 %37)

;stmt13:
  %41 = load %Type*, %Type** %record_type
  call  @print_type (%Type* %41, %Bool 1, %Bool 1)
...
;stmt15:
  ...
  call  @print_type (%Type* %42, %Bool 1, %Bool 1)

;stmt16:
  %43 = bitcast * @func321_str3 to %Str
  call  @o (%Str %43)

;stmt17:
  %44 = load %Value*, %Value** %s
  call  @print_value (%Value* %44)

;stmt18:
  %45 = load %Unit*, %Unit** @fout
  %46 = bitcast * @func321_str4 to %Str
  %47 = call  @fprintf (%Unit* %45, %Str %46, %Nat16 %36)

;stmt19:
  %48 = load %Value*, %Value** %v
  %49 = getelementptr inbounds %Value, %Value* %48, i32 0, i32 1 ; eval_access
  %50 = load %Type*, %Type** %49
  %51 = call  @nv (%Type* %50, %StorageClass 8, %Nat32 %37)
  ret %Value* %51
}
...
;stmt3:
  ...
  %16 = call  @nv (%Type* %12, %StorageClass 9, %Nat32 %15)
  ret %Value* %16
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt5:
  %19 = load %Unit*, %Unit** @fout
  %20 = bitcast * @func322_str1 to %Str
  %21 = call  @fprintf (%Unit* %19, %Str %20, %Nat32 %18)

;stmt6:
  %22 = getelementptr inbounds %Value, %Value* %5, i32 0, i32 1 ; eval_access
  %23 = load %Type*, %Type** %22
  call  @print_type (%Type* %23, %Bool 1, %Bool 1)
...
;stmt8:
  ...
  %25 = load %Type*, %Type** %24
  call  @print_type (%Type* %25, %Bool 1, %Bool 1)

;stmt9:
  %26 = bitcast * @func322_str2 to %Str
  call  @o (%Str %26)

;stmt10:
  call  @print_value (%Value* %5)

;stmt11:
  call  @comma ()

;stmt12:
  %27 = bitcast * @func322_str3 to %Str
  call  @o (%Str %27)
...
;stmt13:
  ...
  %31 = call  @nv (%Type* %30, %StorageClass 9, %Nat32 %18)
  ret %Value* %31
}
...
;stmt1:
  ...
  %13 = call  @nv (%Type* %9, %StorageClass 8, %Nat32 %12)
  ret %Value* %13
}
...
;stmt6:
  ...
  %16 = call  @type_eq (%Type* %14, %Type* %15)
  br i1 %16, label %then_0, label %else_0
then_0:
...
;stmt8:
  %17 = bitcast * @func324_str2 to %Str
  call  @o (%Str %17)
  br label %endif_0
else_0:
...
;stmt10:
  %18 = bitcast * @func324_str3 to %Str
  call  @o (%Str %18)
  br label %endif_0
endif_0:
...
;stmt11:
  ...
  %20 = load %Type*, %Type** %19
  %21 = call  @nv (%Type* %20, %StorageClass 9, %Nat32 %7)
  ret %Value* %21
}
...
;stmt4:
  ...
  %14 = bitcast * @func325_str2 to %Str
  %15 = call  @fprintf (%Unit* %13, %Str %14)
...
;stmt7:
  ...
  %17 = load %Type*, %Type** %16
  %18 = call  @nv (%Type* %17, %StorageClass 9, %Nat32 %7)
  ret %Value* %18
}
...
;stmt3:
  ...
  %6 = getelementptr inbounds , * %5, i32 0, %Int32 0 ; eval_index
...
;stmt5:
  ...
  %11 = load %Type*, %Type** %10
  %12 = call  @type_eq (%Type* %11, %Type* %3)
  br i1 %12, label %then_0, label %else_0
then_0:
...
;stmt9:
  %15 = load %Unit*, %Unit** @fout
  %16 = bitcast * @func326_str1 to %Str
  %17 = call  @fprintf (%Unit* %15, %Str %16, %Nat32 %14)
...
;stmt15:
  %26 = load %Unit*, %Unit** @fout
  %27 = bitcast * @func326_str2 to %Str
  %28 = call  @fprintf (%Unit* %26, %Str %27)
  br label %endif_2
else_2:
...
;stmt17:
  ...
  %30 = bitcast * @func326_str3 to %Str
  %31 = call  @fprintf (%Unit* %29, %Str %30)
  br label %endif_2
endif_2:
  br label %endif_1
else_1:
...
;stmt22:
  %44 = load %Unit*, %Unit** @fout
  %45 = bitcast * @func326_str4 to %Str
  %46 = call  @fprintf (%Unit* %44, %Str %45)
  br label %endif_4
else_4:
...
;stmt24:
  ...
  %48 = bitcast * @func326_str5 to %Str
  %49 = call  @fprintf (%Unit* %47, %Str %48)
  br label %endif_4
endif_4:
  br label %endif_3
else_3:
...
;stmt31:
  ...
  %64 = bitcast * @func326_str6 to %Str
  %65 = call  @fprintf (%Unit* %63, %Str %64)
  br label %endif_7
else_7:
...
;stmt36:
  ...
  %79 = bitcast * @func326_str7 to %Str
  %80 = call  @fprintf (%Unit* %78, %Str %79)
  br label %endif_9
else_9:
...
;stmt38:
  ...
  %82 = bitcast * @func326_str8 to %Str
  %83 = call  @fprintf (%Unit* %81, %Str %82)
  br label %endif_9
endif_9:

;stmt39:
  %84 = load %Unit*, %Unit** @fout
  %85 = bitcast * @func326_str9 to %Str
  %86 = call  @fprintf (%Unit* %84, %Str %85)
  br label %endif_8
else_8:
...
;stmt41:
  ...
  %88 = bitcast * @func326_str10 to %Str
  %89 = call  @fprintf (%Unit* %87, %Str %88)
  br label %endif_8
endif_8:
  br label %endif_7
endif_7:
...
;stmt44:
  ...
  %92 = bitcast * @func326_str11 to %Str
  %93 = call  @fprintf (%Unit* %91, %Str %92)
  br label %endif_10
else_10:
...
;stmt47:
  %95 = bitcast * @func326_str12 to %Str
  %96 = call  @get (%Str %95)
...
;stmt50:
  ...
  %104 = bitcast * @func326_str13 to %Str
  %105 = call  @fprintf (%Unit* %103, %Str %104)
  br label %endif_12
else_12:
...
;stmt53:
  ...
  %111 = bitcast * @func326_str14 to %Str
  %112 = call  @fprintf (%Unit* %110, %Str %111)
  br label %endif_13
else_13:
...
;stmt55:
  %113 = load %Unit*, %Unit** @fout
  %114 = bitcast * @func326_str15 to %Str
  %115 = call  @fprintf (%Unit* %113, %Str %114)
  br label %endif_13
endif_13:
  br label %endif_12
endif_12:
...
;stmt59:
  %117 = bitcast * @func326_str16 to %Str
  %118 = call  @printf (%Str %117, %TypeKind %21)

;stmt60:
  %119 = bitcast * @func326_str17 to %Str
  call  @fatal (%Str %119)
  br label %endif_14
endif_14:
  br label %endif_11
...
;stmt61:
  ...
  call  @print_type (%Type* %121, %Bool 1, %Bool 1)

;stmt62:
  call  @space ()

;stmt63:
  call  @print_value (%Value* %9)

;stmt64:
  %122 = bitcast * @func326_str18 to %Str
  call  @o (%Str %122)

;stmt65:
  call  @print_type (%Type* %3, %Bool 1, %Bool 1)

;stmt66:
  %123 = load %Value*, %Value** %v
  %124 = getelementptr inbounds %Value, %Value* %123, i32 0, i32 1 ; eval_access
  %125 = load %Type*, %Type** %124
  %126 = call  @nv (%Type* %125, %StorageClass 9, %Nat32 %14)
  ret %Value* %126
}
...
;stmt1:
  %1 = bitcast * @func327_str1 to %Str
  store %Str %1, %Str* %o

;stmt2:
  %2 = load %Value*, %Value** %v
  %3 = getelementptr inbounds %Value, %Value* %2, i32 0, i32 3 ; eval_access
  %4 = getelementptr inbounds , * %3, i32 0, %Int32 0 ; eval_index
  %5 = load %Value*, %Value** %4
...
;stmt6:
  %15 = bitcast * @func327_str2 to %Str
  store %Str %15, %Str* %o
  br label %endif_0
else_0:
...
;stmt9:
  %17 = bitcast * @func327_str3 to %Str
  store %Str %17, %Str* %o
  br label %endif_1
else_1:
...
;stmt12:
  %19 = bitcast * @func327_str4 to %Str
  store %Str %19, %Str* %o
  br label %endif_2
else_2:
...
;stmt17:
  %21 = bitcast * @func327_str5 to %Str
  store %Str %21, %Str* %o
  br label %endif_4
else_4:
...
;stmt19:
  %22 = bitcast * @func327_str6 to %Str
  store %Str %22, %Str* %o
  br label %endif_4
endif_4:
  br label %endif_3
...
;stmt24:
  %24 = bitcast * @func327_str7 to %Str
  store %Str %24, %Str* %o
  br label %endif_6
else_6:
...
;stmt26:
  %25 = bitcast * @func327_str8 to %Str
  store %Str %25, %Str* %o
  br label %endif_6
endif_6:
  br label %endif_5
...
;stmt29:
  %27 = bitcast * @func327_str9 to %Str
  store %Str %27, %Str* %o
  br label %endif_7
else_7:
...
;stmt32:
  %29 = bitcast * @func327_str10 to %Str
  store %Str %29, %Str* %o
  br label %endif_8
else_8:
...
;stmt35:
  %31 = bitcast * @func327_str11 to %Str
  store %Str %31, %Str* %o
  br label %endif_9
else_9:
...
;stmt38:
  %33 = bitcast * @func327_str12 to %Str
  store %Str %33, %Str* %o
  br label %endif_10
else_10:
...
;stmt41:
  %35 = bitcast * @func327_str13 to %Str
  store %Str %35, %Str* %o
  br label %endif_11
else_11:
...
;stmt46:
  %37 = bitcast * @func327_str14 to %Str
  store %Str %37, %Str* %o
  br label %endif_13
else_13:
...
;stmt48:
  %38 = bitcast * @func327_str15 to %Str
  store %Str %38, %Str* %o
  br label %endif_13
endif_13:
  br label %endif_12
...
;stmt53:
  %40 = bitcast * @func327_str16 to %Str
  store %Str %40, %Str* %o
  br label %endif_15
else_15:
...
;stmt55:
  %41 = bitcast * @func327_str17 to %Str
  store %Str %41, %Str* %o
  br label %endif_15
endif_15:
  br label %endif_14
...
;stmt60:
  %43 = bitcast * @func327_str18 to %Str
  store %Str %43, %Str* %o
  br label %endif_17
else_17:
...
;stmt62:
  %44 = bitcast * @func327_str19 to %Str
  store %Str %44, %Str* %o
  br label %endif_17
endif_17:
  br label %endif_16
...
;stmt67:
  %46 = bitcast * @func327_str20 to %Str
  store %Str %46, %Str* %o
  br label %endif_19
else_19:
...
;stmt69:
  %47 = bitcast * @func327_str21 to %Str
  store %Str %47, %Str* %o
  br label %endif_19
endif_19:
  br label %endif_18
...
;stmt72:
  %49 = bitcast * @func327_str22 to %Str
  store %Str %49, %Str* %o
  br label %endif_20
else_20:
...
;stmt77:
  %51 = bitcast * @func327_str23 to %Str
  store %Str %51, %Str* %o
  br label %endif_22
else_22:
...
;stmt79:
  %52 = bitcast * @func327_str24 to %Str
  store %Str %52, %Str* %o
  br label %endif_22
endif_22:
  br label %endif_21
...
;stmt80:
  ...
  %55 = getelementptr inbounds , * %54, i32 0, %Int32 0 ; eval_index
  %56 = load %Value*, %Value** %55
  %57 = call  @eval (%Value* %56)
  %58 = call  @load (%Value* %57)
...
;stmt81:
  ...
  %63 = call  @eval (%Value* %62)
  %64 = call  @load (%Value* %63)
...
;stmt83:
  ...
  %67 = bitcast * @func327_str25 to %Str
  %68 = load %Str, %Str* %o
  %69 = call  @fprintf (%Unit* %66, %Str %67, %Nat32 %65, %Str %68)

;stmt84:
  %70 = getelementptr inbounds %Value, %Value* %58, i32 0, i32 1 ; eval_access
  %71 = load %Type*, %Type** %70
  call  @print_type (%Type* %71, %Bool 1, %Bool 1)

;stmt85:
  call  @space ()

;stmt86:
  call  @print_value (%Value* %58)

;stmt87:
  call  @comma ()

;stmt88:
  call  @print_value (%Value* %64)

;stmt89:
  %72 = load %Value*, %Value** %v
  %73 = getelementptr inbounds %Value, %Value* %72, i32 0, i32 1 ; eval_access
  %74 = load %Type*, %Type** %73
  %75 = call  @nv (%Type* %74, %StorageClass 9, %Nat32 %65)
  ret %Value* %75
}
...
;stmt2:
  %6 = load %Unit*, %Unit** @fout
  %7 = bitcast * @func328_str1 to %Str
  %8 = call  @fprintf (%Unit* %6, %Str %7)

;stmt3:
  %9 = getelementptr inbounds %Value, %Value* %5, i32 0, i32 1 ; eval_access
  %10 = load %Type*, %Type** %9
  call  @print_type (%Type* %10, %Bool 1, %Bool 1)
...
;stmt8:
  %13 = bitcast * @func328_str2 to %Str
  call  @o (%Str %13)

;stmt9:
  call  @print_value (%Value* %2)
  ret void
}
...
;stmt0:
  %1 = load %Unit*, %Unit** @fout
  %2 = bitcast * @func330_str1 to %Str
  %3 = load %Str, %Str* %id
  %4 = call  @fprintf (%Unit* %1, %Str %2, %Str %3)

;stmt1:
  %5 = load %Type*, %Type** %t
  call  @print_type (%Type* %5, %Bool 0, %Bool 1)
  ret void
}
...
;stmt4:
  %4 = getelementptr inbounds %Value, %Value* %2, i32 0, i32 1 ; eval_access
  %5 = load %Type*, %Type** %4
  call  @print_type (%Type* %5, %Bool 1, %Bool 1)
...
;stmt0:
  %1 = load %Unit*, %Unit** @fout
  %2 = bitcast * @func331_str1 to %Str
  %3 = load %Str, %Str* %id
  %4 = load %List*, %List** %items
  %5 = getelementptr inbounds %List, %List* %4, i32 0, i32 2 ; eval_access
  %6 = load %Nat64, %Nat64* %5
  %7 = call  @fprintf (%Unit* %1, %Str %2, %Str %3, %Nat64 %6)
...
;stmt2:
  %9 = load %Unit*, %Unit** @fout
  %10 = bitcast * @func331_str2 to %Str
  %11 = call  @fprintf (%Unit* %9, %Str %10)
...
;stmt4:
  ...
  %13 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %12, %ListForeachHandler @print_array_item, %Unit* %13)

;stmt5:
  %14 = load %Unit*, %Unit** @fout
  %15 = bitcast * @func331_str3 to %Str
  %16 = call  @fprintf (%Unit* %14, %Str %15)
  ret void
}
...
;stmt0:
  %1 = load %Unit*, %Unit** @fout
  %2 = bitcast * @func333_str1 to %Str
  %3 = load %Str, %Str* %id
  %4 = load %Nat32, %Nat32* %len
  %5 = call  @fprintf (%Unit* %1, %Str %2, %Str %3, %Nat32 %4)
...
;stmt12:
  ...
  %54 = bitcast * @func333_str10 to %Str
  %55 = call  @fprintf (%Unit* %53, %Str %54, %Nat8 %9)
  br label %endif_1
else_1:
...
;stmt14:
  %56 = load %Unit*, %Unit** @fout
  %57 = bitcast * @func333_str11 to %Str
  %58 = call  @fprintf (%Unit* %56, %Str %57, %Nat8 %9)
  br label %endif_1
endif_1:
  br label %continue_0
break_0:
...
;stmt15:
  ...
  %60 = bitcast * @func333_str12 to %Str
  %61 = call  @fprintf (%Unit* %59, %Str %60, %Int32 0)
  ret void
}
...
;stmt7:
  %11 = bitcast * @func334_str2 to %Str
  call  @o (%Str %11)
  br label %endif_0
endif_0:
  ret void
...
;stmt1:
  ...
  %4 = bitcast * @func337_str1 to %Str
  %5 = getelementptr inbounds %Field, %Field* %2, i32 0, i32 0 ; eval_access
  %6 = load %Str, %Str* %5
  %7 = call  @fprintf (%Unit* %3, %Str %4, %Str %6)
...
;stmt3:
  ...
  %11 = bitcast * @func337_str2 to %Str
  %12 = call  @fprintf (%Unit* %10, %Str %11)

;stmt4:
  %13 = getelementptr inbounds %Field, %Field* %2, i32 0, i32 1 ; eval_access
  %14 = load %Type*, %Type** %13
  call  @print_type (%Type* %14, %Bool 1, %Bool 1)
...
;stmt6:
  %15 = load %Unit*, %Unit** @fout
  %16 = bitcast * @func337_str3 to %Str
  %17 = getelementptr inbounds %Field, %Field* %2, i32 0, i32 0 ; eval_access
  %18 = load %Str, %Str* %17
  %19 = call  @fprintf (%Unit* %15, %Str %16, %Str %18)

;stmt7:
  %20 = getelementptr inbounds %Field, %Field* %2, i32 0, i32 1 ; eval_access
  %21 = load %Type*, %Type** %20
  call  @print_type (%Type* %21, %Bool 1, %Bool 1)

;stmt8:
  %22 = bitcast * @func337_str4 to %Str
  call  @o (%Str %22)

;stmt9:
  %23 = load %Unit*, %Unit** @fout
  %24 = bitcast * @func337_str5 to %Str
  %25 = getelementptr inbounds %Field, %Field* %2, i32 0, i32 0 ; eval_access
  %26 = load %Str, %Str* %25
  %27 = call  @fprintf (%Unit* %23, %Str %24, %Str %26)
  ret void
}
...
;stmt5:
  %11 = bitcast * @func335_str2 to %Str
  call  @o (%Str %11)
  br label %endif_0
else_0:
...
;stmt7:
  %12 = bitcast * @func335_str3 to %Str
  call  @o (%Str %12)
  br label %endif_0
endif_0:
...
;stmt11:
  %19 = bitcast * @func335_str4 to %Str
  call  @o (%Str %19)
  br label %endif_1
else_1:
...
;stmt14:
  %24 = load %Unit*, %Unit** @fout
  %25 = bitcast * @func335_str5 to %Str
  %26 = load %Str, %Str* %id
  %27 = call  @fprintf (%Unit* %24, %Str %25, %Str %26)
...
;stmt16:
  ...
  %31 = load %List*, %List** %30
  %32 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %31, %ListForeachHandler @vf_print_param, %Unit* %32)
...
;stmt19:
  %37 = bitcast * @func335_str6 to %Str
  call  @o (%Str %37)
  br label %endif_2
else_2:
  br label %endif_2
...
;stmt20:
  %38 = bitcast * @func335_str7 to %Str
  call  @o (%Str %38)
...
;stmt23:
  %43 = bitcast * @func335_str8 to %Str
  call  @o (%Str %43)
...
;stmt24:
  ...
  call  @list_foreach (%List* %47, %ListForeachHandler @print_param_loc, %Unit* %48)

;stmt25:
  call  @reset_local_labels ()

;stmt26:
  %49 = load %Block*, %Block** %b
  call  @print_block (%Block* %49)
...
;stmt29:
  %50 = bitcast * @func335_str9 to %Str
  call  @o (%Str %50)
  br label %endif_4
else_4:
  br label %endif_4
...
;stmt30:
  %51 = bitcast * @func335_str10 to %Str
  call  @o (%Str %51)
  br label %endif_3
else_3:
  br label %endif_3
...
;stmt4:
  ...
  %22 = load %Str, %Str* %21
  call  @stringdef (%Str %10, %Nat32 %16, %Str %22)
  br label %endif_0
else_0:
...
;stmt7:
  ...
  call  @arraydef (%Str %25, %Type* %32, %List* %37)
  br label %endif_1
else_1:
...
;stmt10:
  %39 = bitcast * @func339_str1 to %Str
  %40 = inttoptr %Nat32 0 to %Unit*
  %41 = bitcast %Unit* %40 to %TokenInfo*
  call  @error (%Str %39, %TokenInfo* %41)
  br label %endif_2
else_2:
  br label %endif_2
endif_2:
...
;stmt1:
  ...
  %8 = load %Value*, %Value** %7
  call  @vardef (%Str %4, %Type* %6, %Value* %8)
  ret void
}
...
;stmt1:
  ...
  call  @funcdef (%Str %4, %Type* %6, %Block* %8)
  ret void
}
...
;stmt3:
  ...
  %15 = load %List*, %List** %14
  %16 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %15, %ListForeachHandler @foreach_typedef, %Unit* %16)

;stmt4:
  %17 = bitcast * @func342_str4 to %Str
  call  @o (%Str %17)
...
;stmt5:
  ...
  %21 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %20, %ListForeachHandler @foreach_constdef, %Unit* %21)

;stmt6:
  %22 = bitcast * @func342_str5 to %Str
  call  @o (%Str %22)
...
;stmt7:
  ...
  %26 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %25, %ListForeachHandler @foreach_vardef, %Unit* %26)

;stmt8:
  %27 = bitcast * @func342_str6 to %Str
  call  @o (%Str %27)
...
;stmt9:
  ...
  %31 = inttoptr %Nat32 0 to %Unit*
  call  @list_foreach (%List* %30, %ListForeachHandler @foreach_funcdef, %Unit* %31)
  ret void
}
...
;stmt2:
  %3 = load %Unit*, %Unit** @fout
  %4 = bitcast * @func343_str1 to %Str
  %5 = call  @fprintf (%Unit* %3, %Str %4)

;stmt3:
  %6 = load %Unit*, %Unit** @fout
  %7 = bitcast * @func343_str2 to %Str
  %8 = call  @fprintf (%Unit* %6, %Str %7)
  br label %endif_0
else_0:
...
;stmt6:
  %11 = load %Unit*, %Unit** @fout
  %12 = bitcast * @func343_str3 to %Str
  %13 = call  @fprintf (%Unit* %11, %Str %12)

;stmt7:
  %14 = load %Unit*, %Unit** @fout
  %15 = bitcast * @func343_str4 to %Str
  %16 = call  @fprintf (%Unit* %14, %Str %15)
  br label %endif_1
else_1:
  br label %endif_1
...
;stmt8:
  ...
  %18 = bitcast * @func343_str5 to %Str
  %19 = call  @fprintf (%Unit* %17, %Str %18)
  ret void
}
...
;stmt0:
  %1 = load %Unit*, %Unit** @fout
  %2 = bitcast * @func345_str1 to %Str
  %3 = load %Unit*, %Unit** %k
  %4 = bitcast %Unit* %3 to %Str
  %5 = load %Unit*, %Unit** %v
  %6 = call  @fprintf (%Unit* %1, %Str %2, %Str %4, %Unit* %5)
  ret void
}
...
;stmt0:
  %1 = load %Unit*, %Unit** @fout
  %2 = bitcast * @func344_str1 to %Str
  %3 = call  @fprintf (%Unit* %1, %Str %2)

;stmt1:
  %4 = load %List*, %List** %index
  %5 = inttoptr %Nat32 0 to %Unit*
  call  @map_foreach (%List* %4, %MapForeachHandler @tshow, %Unit* %5)
  ret void
}
...
;stmt1:
  %3 = load %Unit*, %Unit** @fout
  %4 = bitcast * @func347_str1 to %Str
  %5 = load %Unit*, %Unit** %k
  %6 = call  @fprintf (%Unit* %3, %Str %4, %Unit* %5, %Value* %2)

;stmt2:
  %7 = load %Unit*, %Unit** @fout
  %8 = bitcast * @func347_str2 to %Str
  %9 = getelementptr inbounds %Value, %Value* %2, i32 0, i32 0 ; eval_access
  %10 = load %ValueKind, %ValueKind* %9
  %11 = call  @print_value_kind (%ValueKind %10)
  %12 = call  @fprintf (%Unit* %7, %Str %8, %Str %11)

;stmt3:
  %13 = load %Unit*, %Unit** @fout
  %14 = bitcast * @func347_str3 to %Str
  %15 = getelementptr inbounds %Value, %Value* %2, i32 0, i32 2 ; eval_access
  %16 = getelementptr inbounds %Storage, %Storage* %15, i32 0, i32 0 ; eval_access
  %17 = load %StorageClass, %StorageClass* %16
  %18 = call  @print_storage_class (%StorageClass %17)
  %19 = call  @fprintf (%Unit* %13, %Str %14, %Str %18)

;stmt4:
  %20 = load %Unit*, %Unit** @fout
  %21 = bitcast * @func347_str4 to %Str
  ...
  %25 = call  @fprintf (%Unit* %20, %Str %21, %Nat32 %24)

;stmt5:
  %26 = load %Unit*, %Unit** @fout
  %27 = bitcast * @func347_str5 to %Str
  %28 = call  @fprintf (%Unit* %26, %Str %27)
  ret void
}
...
;stmt0:
  %1 = load %Unit*, %Unit** @fout
  %2 = bitcast * @func346_str1 to %Str
  %3 = call  @fprintf (%Unit* %1, %Str %2)

;stmt1:
  %4 = load %List*, %List** %index
  %5 = inttoptr %Nat32 0 to %Unit*
  call  @map_foreach (%List* %4, %MapForeachHandler @vshow, %Unit* %5)
  ret void
}
...
;stmt4:
  ...
  %12 = load %Nat32, %Nat32* %11
  %13 = call  @fprintf (%Unit* %8, %Str %9, %Str %2, %Nat32 %12)
  br label %endif_0
else_0:
  br label %endif_0
endif_0:
...
;stmt0:
  %1 = load %Str, %Str* %fname
  %2 = bitcast * @func348_str1 to %Str
  %3 = call  @fopen (%Str %1, %Str %2)
...
;stmt4:
  %8 = load %Unit*, %Unit** @fout
  %9 = bitcast * @func348_str3 to %Str
  %10 = call  @fprintf (%Unit* %8, %Str %9)

;stmt5:
  %11 = load %Unit*, %Unit** @fout
  %12 = bitcast * @func348_str4 to %Str
  %13 = call  @fprintf (%Unit* %11, %Str %12)

;stmt6:
  %14 = load %Arch, %Arch* %a
  call  @print_head (%Arch %14)

;stmt7:
  %15 = load %Unit*, %Unit** @fout
  %16 = bitcast * @func348_str5 to %Str
  %17 = call  @fprintf (%Unit* %15, %Str %16)

;stmt8:
  %18 = load %Unit*, %Unit** @fout
  %19 = bitcast * @func348_str6 to %Str
  %20 = call  @fprintf (%Unit* %18, %Str %19)

;stmt9:
  %21 = load %Unit*, %Unit** @fout
  %22 = bitcast * @func348_str7 to %Str
  %23 = call  @fprintf (%Unit* %21, %Str %22)

;stmt10:
  %24 = load %Unit*, %Unit** @fout
  %25 = bitcast * @func348_str8 to %Str
  %26 = call  @fprintf (%Unit* %24, %Str %25)

;stmt11:
  %27 = load %List*, %List** @globalTypeIndex
  %28 = inttoptr %Nat32 0 to %Unit*
  call  @map_foreach (%List* %27, %MapForeachHandler @prt_itype, %Unit* %28)

;stmt12:
  %29 = load %Unit*, %Unit** @fout
  %30 = bitcast * @func348_str9 to %Str
  %31 = call  @fprintf (%Unit* %29, %Str %30)
  ret void
}
...
;stmt0:
  %1 = bitcast * @func350_str1 to %Str
  %2 = call  @type_basic_new (%Str %1, %Nat32 1, %Nat32 0, %Bool 0, %Bool 0)
  store %Type* %2, %Type** @typeUnit

;stmt1:
  %3 = bitcast * @func350_str2 to %Str
  %4 = call  @type_basic_new (%Str %3, %Nat32 1, %Nat32 1, %Bool 0, %Bool 0)
  store %Type* %4, %Type** @typeBool

;stmt2:
  %5 = bitcast * @func350_str3 to %Str
  %6 = load %Type*, %Type** @typeUnit
  call  @bind_type_builtin (%Str %5, %Type* %6)

;stmt3:
  %7 = bitcast * @func350_str4 to %Str
  %8 = load %Type*, %Type** @typeBool
  call  @bind_type_builtin (%Str %7, %Type* %8)

;stmt4:
  %9 = bitcast * @func350_str5 to %Str
  %10 = call  @type_basic_new (%Str %9, %Nat32 1, %Nat32 8, %Bool 1, %Bool 1)

;stmt5:
  %11 = bitcast * @func350_str6 to %Str
  %12 = call  @type_basic_new (%Str %11, %Nat32 2, %Nat32 16, %Bool 1, %Bool 1)

;stmt6:
  %13 = bitcast * @func350_str7 to %Str
  %14 = call  @type_basic_new (%Str %13, %Nat32 4, %Nat32 32, %Bool 1, %Bool 1)

;stmt7:
  %15 = bitcast * @func350_str8 to %Str
  %16 = call  @type_basic_new (%Str %15, %Nat32 8, %Nat32 64, %Bool 1, %Bool 1)

;stmt8:
  %17 = bitcast * @func350_str9 to %Str
  %18 = call  @type_basic_new (%Str %17, %Nat32 16, %Nat32 128, %Bool 1, %Bool 1)

;stmt9:
  %19 = bitcast * @func350_str10 to %Str
  %20 = call  @type_basic_new (%Str %19, %Nat32 32, %Nat32 256, %Bool 1, %Bool 1)

;stmt10:
  %21 = bitcast * @func350_str11 to %Str
  %22 = call  @type_basic_new (%Str %21, %Nat32 64, %Nat32 512, %Bool 1, %Bool 1)

;stmt11:
  %23 = bitcast * @func350_str12 to %Str
  %24 = call  @type_basic_new (%Str %23, %Nat32 128, %Nat32 1024, %Bool 1, %Bool 1)

;stmt12:
  %25 = bitcast * @func350_str13 to %Str
  %26 = call  @type_basic_new (%Str %25, %Nat32 1, %Nat32 8, %Bool 1, %Bool 0)

;stmt13:
  %27 = bitcast * @func350_str14 to %Str
  %28 = call  @type_basic_new (%Str %27, %Nat32 2, %Nat32 16, %Bool 1, %Bool 0)

;stmt14:
  %29 = bitcast * @func350_str15 to %Str
  %30 = call  @type_basic_new (%Str %29, %Nat32 4, %Nat32 32, %Bool 1, %Bool 0)

;stmt15:
  %31 = bitcast * @func350_str16 to %Str
  %32 = call  @type_basic_new (%Str %31, %Nat32 8, %Nat32 64, %Bool 1, %Bool 0)

;stmt16:
  %33 = bitcast * @func350_str17 to %Str
  %34 = call  @type_basic_new (%Str %33, %Nat32 16, %Nat32 128, %Bool 1, %Bool 0)

;stmt17:
  %35 = bitcast * @func350_str18 to %Str
  %36 = call  @type_basic_new (%Str %35, %Nat32 32, %Nat32 256, %Bool 1, %Bool 0)

;stmt18:
  %37 = bitcast * @func350_str19 to %Str
  %38 = call  @type_basic_new (%Str %37, %Nat32 64, %Nat32 512, %Bool 1, %Bool 0)

;stmt19:
  %39 = bitcast * @func350_str20 to %Str
  %40 = call  @type_basic_new (%Str %39, %Nat32 128, %Nat32 1024, %Bool 1, %Bool 0)

;stmt20:
  %41 = bitcast * @func350_str21 to %Str
  call  @bind_type_builtin (%Str %41, %Type* %16)

;stmt21:
  %42 = bitcast * @func350_str22 to %Str
  call  @bind_type_builtin (%Str %42, %Type* %32)

;stmt22:
  %43 = bitcast * @func350_str23 to %Str
  call  @bind_type_builtin (%Str %43, %Type* %14)

;stmt23:
  %44 = bitcast * @func350_str24 to %Str
  call  @bind_type_builtin (%Str %44, %Type* %30)

;stmt24:
  %45 = bitcast * @func350_str25 to %Str
  call  @bind_type_builtin (%Str %45, %Type* %10)

;stmt25:
  %46 = bitcast * @func350_str26 to %Str
  call  @bind_type_builtin (%Str %46, %Type* %26)

;stmt26:
  %47 = bitcast * @func350_str27 to %Str
  call  @bind_type_builtin (%Str %47, %Type* %12)

;stmt27:
  %48 = bitcast * @func350_str28 to %Str
  call  @bind_type_builtin (%Str %48, %Type* %28)
...
;stmt29:
  ...
  %50 = call  @type_array_new (%Type* %49, %Nat32 0, %Bool 1)
  store %Type* %50, %Type** @typeStr

;stmt30:
  %51 = load %Type*, %Type** @typeStr
  %52 = getelementptr inbounds %Type, %Type* %51, i32 0, i32 1 ; eval_access
  %53 = bitcast * @func350_str29 to %Str
  store %Str %53, %Str* %52

;stmt31:
  %54 = bitcast * @func350_str30 to %Str
  %55 = load %Type*, %Type** @typeStr
  call  @bind_type_builtin (%Str %54, %Type* %55)

;stmt32:
  %56 = bitcast * @func350_str31 to %Str
  call  @bind_type_builtin (%Str %56, %Type* %18)

;stmt33:
  %57 = bitcast * @func350_str32 to %Str
  call  @bind_type_builtin (%Str %57, %Type* %20)

;stmt34:
  %58 = bitcast * @func350_str33 to %Str
  call  @bind_type_builtin (%Str %58, %Type* %22)

;stmt35:
  %59 = bitcast * @func350_str34 to %Str
  call  @bind_type_builtin (%Str %59, %Type* %24)

;stmt36:
  %60 = bitcast * @func350_str35 to %Str
  call  @bind_type_builtin (%Str %60, %Type* %34)

;stmt37:
  %61 = bitcast * @func350_str36 to %Str
  call  @bind_type_builtin (%Str %61, %Type* %36)

;stmt38:
  %62 = bitcast * @func350_str37 to %Str
  call  @bind_type_builtin (%Str %62, %Type* %38)

;stmt39:
  %63 = bitcast * @func350_str38 to %Str
  call  @bind_type_builtin (%Str %63, %Type* %40)

;stmt40:
  %64 = load %Type*, %Type** @typeUnit
  %65 = call  @type_pointer_new (%Type* %64)
...
;stmt1:
  %3 = bitcast * @func351_str1 to %Str
  call  @bind_value_builtin (%Str %3, %Value* %2)

;stmt2:
  %4 = load %Type*, %Type** @typeBool
  %5 = call  @value_new_imm_const (%Type* %4, %Int64 1)

;stmt3:
  %6 = bitcast * @func351_str2 to %Str
  call  @bind_value_builtin (%Str %6, %Value* %5)
  ret void
}
...
;stmt3:
  %6 = bitcast * @MINOR_LIB_ENV_VAR to %Str
  %7 = call  @getenv (%Str %6)
...
;stmt6:
  %11 = bitcast * @func352_str1 to %Str
  call  @fatal (%Str %11)
  br label %endif_0
else_0:
  br label %endif_0
...
;stmt7:
  call  @liblist_add (%Str %7)

;stmt8:
  %12 = getelementptr inbounds %Assembly, %Assembly* @asm0, i32 0 ; ref
  %13 = bitcast * @func352_str2 to %Str
  call  @asm_init (%Assembly* %12, %Str %13)
...
;stmt12:
  %17 = bitcast * @func352_str3 to %Str
  call  @set (%Str %17, %Nat64 64)

;stmt13:
  %18 = bitcast * @func352_str4 to %Str
  call  @set (%Str %18, %Nat64 8)

;stmt14:
  %19 = bitcast * @func352_str5 to %Str
  call  @set (%Str %19, %Nat64 1)

;stmt15:
  %20 = bitcast * @func352_str6 to %Str
  call  @set (%Str %20, %Nat64 2)

;stmt16:
  %21 = bitcast * @func352_str7 to %Str
  call  @set (%Str %21, %Nat64 8)

;stmt17:
  %22 = bitcast * @func352_str8 to %Str
  call  @set (%Str %22, %Nat64 8)

;stmt18:
  %23 = bitcast * @func352_str9 to %Str
  call  @set (%Str %23, %Nat64 0)
...
;stmt4:
  %8 = bitcast * @func353_str1 to %Str
  %9 = inttoptr %Nat32 0 to %Unit*
  %10 = bitcast %Unit* %9 to %TokenInfo*
  call  @error (%Str %8, %TokenInfo* %10)
...
;stmt14:
  %15 = bitcast * @func353_str2 to %Str
  %16 = call  @need (%Str %15)
...
;stmt18:
  ...
  %22 = bitcast * %21 to %Unit*
  %23 = bitcast * @func353_str3 to %Str
  %24 = getelementptr inbounds %Nat64, %Nat64* %d, i32 0 ; ref
  %25 = call  @sscanf (%Unit* %22, %Str %23, %Nat64* %24)
...
;stmt20:
  %26 = bitcast * @func353_str4 to %Str
  %27 = load %Nat64, %Nat64* %d
  %28 = call  @printf (%Str %26, %Str %14, %Nat64 %27)

;stmt21:
  %29 = load %Nat64, %Nat64* %d
  call  @set (%Str %14, %Nat64 %29)
  br label %continue_0
break_0:
  ret void
}

define %Int32 @main (%Int32 %_argc,  %_argv) {
  %argc = alloca %Int32
...
;stmt0:
  %1 = bitcast * @func354_str1 to %Str
  %2 = call  @printf (%Str %1, %Int32 0, %Int32 5)

;stmt1:
  call  @init ()

;stmt2:
  %3 = bitcast * @func354_str2 to %Str
  %4 = call  @source_open (%Str %3)
  call  @parse (%Source* %4)

;stmt3:
  %5 = bitcast * @func354_str3 to %Str
  %6 = load %Nat32, %Nat32* @lines
  %7 = call  @printf (%Str %5, %Nat32 %6)
...
;stmt7:
  %10 = bitcast * @func354_str4 to %Str
  %11 = load %Nat32, %Nat32* @errcnt
  %12 = call  @printf (%Str %10, %Nat32 %11)
...
;stmt13:
  %18 = load , * %argv
  %19 = getelementptr inbounds %Str,  %18, %Int32 1 ; eval_index
  %20 = load %Str, %Str* %19
  %21 = bitcast * @func354_str5 to %Str
  %22 = call  @strcmp (%Str %20, %Str %21)
...
;stmt15:
  %24 = bitcast * @func354_str6 to %Str
  %25 = call  @printf (%Str %24)
...
;stmt17:
  ...
  %27 = bitcast * @func354_str7 to %Str
  call  @printer_init (%Arch %26, %Str %27)

;stmt18:
  %28 = getelementptr inbounds %Assembly, %Assembly* @asm0, i32 0 ; ref
  call  @print_assembly (%Assembly* %28)
...
;stmt0:
  %1 = bitcast * @func355_str1 to %Str
  %2 = call  @printf (%Str %1)

;stmt1:
  %3 = bitcast * @func355_str2 to %Str
  %4 = call  @printf (%Str %3)
  ret void
}